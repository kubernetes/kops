...
var dockerVersions = []packageVersion{
	...
	// 19.03.8 - Linux Generic Arm64
	{
		PackageVersion: "19.03.8",
		PlainBinary:    true,
		Architectures:  []architectures.Architecture{architectures.ArchitectureArm64},
		Source:         "https://download.docker.com/linux/static/stable/aarch64/docker-19.03.8.tgz",
		Hash:           "e3c06e4e12e786d51edd88c8fe613a2aa078d7e9",
	},
