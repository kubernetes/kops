...
func appendGPURuntimeContainerdConfig(config *toml.Tree) error {
	...
	config.SetPath([]string{"plugins", "io.containerd.grpc.v1.cri", "containerd", "default_runtime_name"}, "nvidia")
