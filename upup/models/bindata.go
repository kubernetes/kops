...
func cloudup_awsResourcesNodeupShTemplate() (*asset, error) {
	...
	info := bindataFileInfo{name: "cloudup/_aws/resources/nodeup.sh.template", size: 3365, mode: os.FileMode(493), modTime: time.Unix(1473303872, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func cloudup_gceResourcesNodeupShTemplate() (*asset, error) {
	...
	info := bindataFileInfo{name: "cloudup/_gce/resources/nodeup.sh.template", size: 4209, mode: os.FileMode(493), modTime: time.Unix(1473303872, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func proto_awsMaster_volumesYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "proto/_aws/master_volumes.yaml", size: 525, mode: os.FileMode(420), modTime: time.Unix(1473309410, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
