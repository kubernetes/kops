...
func (o *LoadBalancerConnectionSettings) GetName() *string {
	return o.Name
}

// SetName sets the Name of the object, implementing fi.SetName
func (o *LoadBalancerConnectionSettings) SetName(name string) {
	o.Name = &name
}

// String is the stringer function for the task, producing readable output using fi.TaskAsString
func (o *LoadBalancerConnectionSettings) String() string {
