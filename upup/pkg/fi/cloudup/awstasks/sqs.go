...
func (q *SQS) RenderAWS(ctx *fi.Context, t *awsup.AWSAPITarget, a, e, changes *SQS) error {
...
func (_ *SQS) RenderTerraform(ctx *fi.Context, t *terraform.TerraformTarget, a, e, changes *SQS) error {
