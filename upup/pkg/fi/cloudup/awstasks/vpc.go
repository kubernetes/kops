...
func (_ *VPC) RenderAWS(ctx *fi.Context, t *awsup.AWSAPITarget, a, e, changes *VPC) error {
...
func (_ *VPC) RenderTerraform(ctx *fi.Context, t *terraform.TerraformTarget, a, e, changes *VPC) error {
