...
func (_ *VPCCIDRBlock) RenderAWS(ctx *fi.Context, t *awsup.AWSAPITarget, a, e, changes *VPCCIDRBlock) error {
...
func (_ *VPCCIDRBlock) RenderTerraform(ctx *fi.Context, t *terraform.TerraformTarget, a, e, changes *VPCCIDRBlock) error {
	shared := aws.BoolValue(e.Shared)
	if shared && a == nil {
		// VPC not owned by kOps, no changes will be applied
		// Verify that the CIDR block was found.
