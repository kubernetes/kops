...
func (_ *IAMRolePolicy) RenderAWS(ctx *fi.Context, t *awsup.AWSAPITarget, a, e, changes *IAMRolePolicy) error {
...
func (_ *IAMRolePolicy) RenderTerraform(ctx *fi.Context, t *terraform.TerraformTarget, a, e, changes *IAMRolePolicy) error {
