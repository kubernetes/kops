...
func (_ *ClassicLoadBalancer) RenderAWS(ctx *fi.Context, t *awsup.AWSAPITarget, a, e, changes *ClassicLoadBalancer) error {
	shared := fi.ValueOf(e.Shared)
	if shared {
		return nil
	}
...
func (_ *ClassicLoadBalancer) RenderTerraform(ctx *fi.Context, t *terraform.TerraformTarget, a, e, changes *ClassicLoadBalancer) error {
	shared := fi.ValueOf(e.Shared)
	if shared {
		return nil
	}
