...
func (*WarmPool) RenderAWS(ctx *fi.Context, t *awsup.AWSAPITarget, a, e, changes *WarmPool) error {
...
func (_ *WarmPool) RenderTerraform(ctx *fi.Context, t *terraform.TerraformTarget, a, e, changes *WarmPool) error {
	if changes != nil {
