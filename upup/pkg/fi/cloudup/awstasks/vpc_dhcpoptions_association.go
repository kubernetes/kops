...
func (_ *VPCDHCPOptionsAssociation) RenderAWS(ctx *fi.Context, t *awsup.AWSAPITarget, a, e, changes *VPCDHCPOptionsAssociation) error {
...
func (_ *VPCDHCPOptionsAssociation) RenderTerraform(ctx *fi.Context, t *terraform.TerraformTarget, a, e, changes *VPCDHCPOptionsAssociation) error {
