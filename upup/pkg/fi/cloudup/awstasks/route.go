...
func (_ *Route) RenderAWS(ctx *fi.Context, t *awsup.AWSAPITarget, a, e, changes *Route) error {
	if a == nil {
...
func (_ *Route) RenderTerraform(ctx *fi.Context, t *terraform.TerraformTarget, a, e, changes *Route) error {
	tf := &terraformRoute{
