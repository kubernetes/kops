...
func (eb *EventBridgeRule) RenderAWS(ctx *fi.Context, t *awsup.AWSAPITarget, a, e, changes *EventBridgeRule) error {
...
func (_ *EventBridgeRule) RenderTerraform(ctx *fi.Context, t *terraform.TerraformTarget, a, e, changes *EventBridgeRule) error {
