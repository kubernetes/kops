...
func (_ *IAMInstanceProfile) RenderAWS(ctx *fi.Context, t *awsup.AWSAPITarget, a, e, changes *IAMInstanceProfile) error {
...
func (_ *IAMInstanceProfile) RenderTerraform(ctx *fi.Context, t *terraform.TerraformTarget, a, e, changes *IAMInstanceProfile) error {
