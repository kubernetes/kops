...
func (_ *TargetGroup) RenderAWS(ctx *fi.Context, t *awsup.AWSAPITarget, a, e, changes *TargetGroup) error {
...
func (_ *TargetGroup) RenderTerraform(ctx *fi.Context, t *terraform.TerraformTarget, a, e, changes *TargetGroup) error {
	shared := fi.ValueOf(e.Shared)
	if shared {
		return nil
	}
