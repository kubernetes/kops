...
func (_ *NetworkLoadBalancer) RenderAWS(ctx *fi.Context, t *awsup.AWSAPITarget, a, e, changes *NetworkLoadBalancer) error {
...
func (_ *NetworkLoadBalancer) RenderTerraform(ctx *fi.Context, t *terraform.TerraformTarget, a, e, changes *NetworkLoadBalancer) error {
