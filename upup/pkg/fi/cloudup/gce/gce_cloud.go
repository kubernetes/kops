...
func (c *GCECloud) GetApiIngressStatus(cluster *kops.Cluster) ([]status.ApiIngressStatus, error) {
	var ingresses []status.ApiIngressStatus
	...
	if forwardingRule != nil {
		...
		ingresses = append(ingresses, status.ApiIngressStatus{
