...
func (_ *ServerGroup) RenderHetzer(ctx *fi.Context, t *hetzner.HetznerAPITarget, a, e, changes *ServerGroup) error {
...
func (_ *ServerGroup) RenderTerraform(ctx *fi.Context, t *terraform.TerraformTarget, a, e, changes *ServerGroup) error {
