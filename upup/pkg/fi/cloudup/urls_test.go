...
func Test_BuildMirroredAsset(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			expected: []string{
				"https://artifacts.k8s.io/binaries/kops/1.21.3/images/protokube-linux-amd64",
				"https://github.com/kubernetes/kops/releases/download/v1.21.3/images-protokube-linux-amd64",
			},
		},
		{
			url: "https://artifacts.k8s.io/binaries/kops/%s/images/protokube-linux-arm64",
			expected: []string{
				"https://artifacts.k8s.io/binaries/kops/1.21.3/images/protokube-linux-arm64",
				"https://github.com/kubernetes/kops/releases/download/v1.21.3/images-protokube-linux-arm64",
			},
		},
		{
			url: "https://artifacts.k8s.io/binaries/kops/%s/linux/amd64/nodeup",
			expected: []string{
				"https://artifacts.k8s.io/binaries/kops/1.21.3/linux/amd64/nodeup",
				"https://github.com/kubernetes/kops/releases/download/v1.21.3/nodeup-linux-amd64",
			},
		},
		{
			url: "https://artifacts.k8s.io/binaries/kops/%s/linux/arm64/nodeup",
			expected: []string{
				"https://artifacts.k8s.io/binaries/kops/1.21.3/linux/arm64/nodeup",
				"https://github.com/kubernetes/kops/releases/download/v1.21.3/nodeup-linux-arm64",
			},
		},
	}
