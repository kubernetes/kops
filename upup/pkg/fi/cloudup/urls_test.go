...
func Test_BuildMirroredAsset(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			expected: []string{
				"https://artifacts.k8s.io/binaries/kops/1.28.0-beta.1/linux/amd64/nodeup",
				"https://github.com/kubernetes/kops/releases/download/v1.28.0-beta.1/nodeup-linux-amd64",
			},
		},
		{
			url: "https://artifacts.k8s.io/binaries/kops/%s/linux/arm64/nodeup",
			expected: []string{
				"https://artifacts.k8s.io/binaries/kops/1.28.0-beta.1/linux/arm64/nodeup",
				"https://github.com/kubernetes/kops/releases/download/v1.28.0-beta.1/nodeup-linux-arm64",
			},
		},
	}
