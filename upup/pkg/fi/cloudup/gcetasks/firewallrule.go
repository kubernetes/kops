...
func (_ *FirewallRule) RenderGCE(ctx *fi.Context, t *gce.GCEAPITarget, a, e, changes *FirewallRule) error {
	cloud := t.Cloud
...
func (_ *FirewallRule) RenderTerraform(ctx *fi.Context, t *terraform.TerraformTarget, a, e, changes *FirewallRule) error {
