...
func (_ *TargetPool) RenderGCE(ctx *fi.Context, t *gce.GCEAPITarget, a, e, changes *TargetPool) error {
	name := fi.ValueOf(e.Name)
...
func (_ *TargetPool) RenderTerraform(ctx *fi.Context, t *terraform.TerraformTarget, a, e, changes *TargetPool) error {
	name := fi.ValueOf(e.Name)
