...
func (_ *StorageBucketAcl) RenderGCE(ctx *fi.Context, t *gce.GCEAPITarget, a, e, changes *StorageBucketAcl) error {
	bucket := fi.ValueOf(e.Bucket)
	entity := fi.ValueOf(e.Entity)
...
func (_ *StorageBucketAcl) RenderTerraform(ctx *fi.Context, t *terraform.TerraformTarget, a, e, changes *StorageBucketAcl) error {
