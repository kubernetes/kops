...
func (_ *BackendService) RenderGCE(ctx *fi.Context, t *gce.GCEAPITarget, a, e, changes *BackendService) error {
	cloud := t.Cloud
	var hcs []string
...
func (_ *BackendService) RenderTerraform(ctx *fi.Context, t *terraform.TerraformTarget, a, e, changes *BackendService) error {
