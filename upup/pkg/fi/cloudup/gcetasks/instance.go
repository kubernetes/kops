...
func (_ *Instance) RenderGCE(ctx *fi.Context, t *gce.GCEAPITarget, a, e, changes *Instance) error {
	cloud := t.Cloud
...
func (_ *Instance) RenderTerraform(ctx *fi.Context, t *terraform.TerraformTarget, a, e, changes *Instance) error {
	project := t.Project
