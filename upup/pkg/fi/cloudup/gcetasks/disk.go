...
func (_ *Disk) RenderGCE(ctx *fi.Context, t *gce.GCEAPITarget, a, e, changes *Disk) error {
	cloud := t.Cloud
...
func (_ *Disk) RenderTerraform(ctx *fi.Context, t *terraform.TerraformTarget, a, e, changes *Disk) error {
