...
func (_ *ForwardingRule) RenderGCE(ctx *fi.Context, t *gce.GCEAPITarget, a, e, changes *ForwardingRule) error {
	name := fi.ValueOf(e.Name)
...
func (_ *ForwardingRule) RenderTerraform(ctx *fi.Context, t *terraform.TerraformTarget, a, e, changes *ForwardingRule) error {
	name := fi.ValueOf(e.Name)
