...
func (o *LaunchSpec) RenderAWS(ctx *fi.Context, t *awsup.AWSAPITarget, a, e, changes *LaunchSpec) error {
...
func (_ *LaunchSpec) RenderTerraform(ctx *fi.Context, t *terraform.TerraformTarget, a, e, changes *LaunchSpec) error {
