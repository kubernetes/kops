...
func NewClientsetSSHCredentialStore(ctx context.Context, cluster *kops.Cluster, clientset kopsinternalversion.KopsInterface, namespace string) SSHCredentialStore {
