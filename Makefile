...
KUBE_APISERVER_HEALTHCHECK_TAG=1.25.4
...
crds:
	...
	"${KOPS_ROOT}/_output/bin/controller-gen" paths=k8s.io/kops/pkg/apis/kops/v1alpha2 output:dir=k8s/crds/ crd:crdVersions=v1
