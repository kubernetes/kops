...
push-vsphere: nodeup protokube-push
	...
	# ssh -t root@10.161.56.108 'export AWS_ACCESS_KEY_ID="***REMOVED***"; export AWS_SECRET_ACCESS_KEY="***REMOVED***"; export AWS_REGION="us-west-2"; SKIP_PACKAGE_UPDATE=1 ~/nodeup --conf=/var/cache/kubernetes-install/kube_env.yaml --v=8'
