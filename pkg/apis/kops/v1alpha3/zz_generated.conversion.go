...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*PodDisruptionBudgetConfig)(nil), (*kops.PodDisruptionBudgetConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha3_PodDisruptionBudgetConfig_To_kops_PodDisruptionBudgetConfig(a.(*PodDisruptionBudgetConfig), b.(*kops.PodDisruptionBudgetConfig), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*kops.PodDisruptionBudgetConfig)(nil), (*PodDisruptionBudgetConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_kops_PodDisruptionBudgetConfig_To_v1alpha3_PodDisruptionBudgetConfig(a.(*kops.PodDisruptionBudgetConfig), b.(*PodDisruptionBudgetConfig), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha3_KubeDNSConfig_To_kops_KubeDNSConfig(in *KubeDNSConfig, out *kops.KubeDNSConfig, s conversion.Scope) error {
	...
	if in.PodDisruptionBudget != nil {
		...
		*out = new(kops.PodDisruptionBudgetConfig)
		if err := Convert_v1alpha3_PodDisruptionBudgetConfig_To_kops_PodDisruptionBudgetConfig(*in, *out, s); err != nil {
			return err
		}
	} else {
...
func autoConvert_kops_KubeDNSConfig_To_v1alpha3_KubeDNSConfig(in *kops.KubeDNSConfig, out *KubeDNSConfig, s conversion.Scope) error {
	...
	if in.PodDisruptionBudget != nil {
		...
		*out = new(PodDisruptionBudgetConfig)
		if err := Convert_kops_PodDisruptionBudgetConfig_To_v1alpha3_PodDisruptionBudgetConfig(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.PodDisruptionBudget = nil
...
func autoConvert_v1alpha3_PodDisruptionBudgetConfig_To_kops_PodDisruptionBudgetConfig(in *PodDisruptionBudgetConfig, out *kops.PodDisruptionBudgetConfig, s conversion.Scope) error {
	out.MinAvailable = in.MinAvailable
	out.MaxUnavailable = in.MaxUnavailable
	return nil
}

// Convert_v1alpha3_PodDisruptionBudgetConfig_To_kops_PodDisruptionBudgetConfig is an autogenerated conversion function.
func Convert_v1alpha3_PodDisruptionBudgetConfig_To_kops_PodDisruptionBudgetConfig(in *PodDisruptionBudgetConfig, out *kops.PodDisruptionBudgetConfig, s conversion.Scope) error {
	return autoConvert_v1alpha3_PodDisruptionBudgetConfig_To_kops_PodDisruptionBudgetConfig(in, out, s)
}

func autoConvert_kops_PodDisruptionBudgetConfig_To_v1alpha3_PodDisruptionBudgetConfig(in *kops.PodDisruptionBudgetConfig, out *PodDisruptionBudgetConfig, s conversion.Scope) error {
	out.MinAvailable = in.MinAvailable
	out.MaxUnavailable = in.MaxUnavailable
	return nil
}

// Convert_kops_PodDisruptionBudgetConfig_To_v1alpha3_PodDisruptionBudgetConfig is an autogenerated conversion function.
func Convert_kops_PodDisruptionBudgetConfig_To_v1alpha3_PodDisruptionBudgetConfig(in *kops.PodDisruptionBudgetConfig, out *PodDisruptionBudgetConfig, s conversion.Scope) error {
	return autoConvert_kops_PodDisruptionBudgetConfig_To_v1alpha3_PodDisruptionBudgetConfig(in, out, s)
}
