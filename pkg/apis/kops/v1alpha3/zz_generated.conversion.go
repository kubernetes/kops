...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*GCPSpec)(nil), (*kops.GCPSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha3_GCPSpec_To_kops_GCPSpec(a.(*GCPSpec), b.(*kops.GCPSpec), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*kops.GCPSpec)(nil), (*GCPSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_kops_GCPSpec_To_v1alpha3_GCPSpec(a.(*kops.GCPSpec), b.(*GCPSpec), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha3_CloudProviderSpec_To_kops_CloudProviderSpec(in *CloudProviderSpec, out *kops.CloudProviderSpec, s conversion.Scope) error {
	...
	if in.GCP != nil {
		...
		*out = new(kops.GCPSpec)
		if err := Convert_v1alpha3_GCPSpec_To_kops_GCPSpec(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.GCP = nil
...
func autoConvert_kops_CloudProviderSpec_To_v1alpha3_CloudProviderSpec(in *kops.CloudProviderSpec, out *CloudProviderSpec, s conversion.Scope) error {
	...
	if in.GCP != nil {
		in, out := &in.GCP, &out.GCP
		*out = new(GCPSpec)
		if err := Convert_kops_GCPSpec_To_v1alpha3_GCPSpec(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.GCP = nil
...
func autoConvert_v1alpha3_GCPSpec_To_kops_GCPSpec(in *GCPSpec, out *kops.GCPSpec, s conversion.Scope) error {
	out.Project = in.Project
	return nil
}

// Convert_v1alpha3_GCPSpec_To_kops_GCPSpec is an autogenerated conversion function.
func Convert_v1alpha3_GCPSpec_To_kops_GCPSpec(in *GCPSpec, out *kops.GCPSpec, s conversion.Scope) error {
	return autoConvert_v1alpha3_GCPSpec_To_kops_GCPSpec(in, out, s)
}

func autoConvert_kops_GCPSpec_To_v1alpha3_GCPSpec(in *kops.GCPSpec, out *GCPSpec, s conversion.Scope) error {
	out.Project = in.Project
	return nil
}

// Convert_kops_GCPSpec_To_v1alpha3_GCPSpec is an autogenerated conversion function.
func Convert_kops_GCPSpec_To_v1alpha3_GCPSpec(in *kops.GCPSpec, out *GCPSpec, s conversion.Scope) error {
	return autoConvert_kops_GCPSpec_To_v1alpha3_GCPSpec(in, out, s)
}
