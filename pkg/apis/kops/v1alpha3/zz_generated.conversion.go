...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*RegistryMirrorAuthConfig)(nil), (*kops.RegistryMirrorAuthConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha3_RegistryMirrorAuthConfig_To_kops_RegistryMirrorAuthConfig(a.(*RegistryMirrorAuthConfig), b.(*kops.RegistryMirrorAuthConfig), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*kops.RegistryMirrorAuthConfig)(nil), (*RegistryMirrorAuthConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_kops_RegistryMirrorAuthConfig_To_v1alpha3_RegistryMirrorAuthConfig(a.(*kops.RegistryMirrorAuthConfig), b.(*RegistryMirrorAuthConfig), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha3_ContainerdConfig_To_kops_ContainerdConfig(in *ContainerdConfig, out *kops.ContainerdConfig, s conversion.Scope) error {
	...
	if in.RegistryMirrorAuthConfigs != nil {
		in, out := &in.RegistryMirrorAuthConfigs, &out.RegistryMirrorAuthConfigs
		*out = make([]kops.RegistryMirrorAuthConfig, len(*in))
		for i := range *in {
			if err := Convert_v1alpha3_RegistryMirrorAuthConfig_To_kops_RegistryMirrorAuthConfig(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
		out.RegistryMirrorAuthConfigs = nil
	}
	out.Root = in.Root
...
func autoConvert_kops_ContainerdConfig_To_v1alpha3_ContainerdConfig(in *kops.ContainerdConfig, out *ContainerdConfig, s conversion.Scope) error {
	...
	if in.RegistryMirrorAuthConfigs != nil {
		in, out := &in.RegistryMirrorAuthConfigs, &out.RegistryMirrorAuthConfigs
		*out = make([]RegistryMirrorAuthConfig, len(*in))
		for i := range *in {
			if err := Convert_kops_RegistryMirrorAuthConfig_To_v1alpha3_RegistryMirrorAuthConfig(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_v1alpha3_RegistryMirrorAuthConfig_To_kops_RegistryMirrorAuthConfig(in *RegistryMirrorAuthConfig, out *kops.RegistryMirrorAuthConfig, s conversion.Scope) error {
...
// Convert_v1alpha3_RegistryMirrorAuthConfig_To_kops_RegistryMirrorAuthConfig is an autogenerated conversion function.
func Convert_v1alpha3_RegistryMirrorAuthConfig_To_kops_RegistryMirrorAuthConfig(in *RegistryMirrorAuthConfig, out *kops.RegistryMirrorAuthConfig, s conversion.Scope) error {
	return autoConvert_v1alpha3_RegistryMirrorAuthConfig_To_kops_RegistryMirrorAuthConfig(in, out, s)
}

func autoConvert_kops_RegistryMirrorAuthConfig_To_v1alpha3_RegistryMirrorAuthConfig(in *kops.RegistryMirrorAuthConfig, out *RegistryMirrorAuthConfig, s conversion.Scope) error {
	out.EndpointUrl = in.EndpointUrl
	out.AuthUsername = in.AuthUsername
	out.AuthPassword = in.AuthPassword
	out.AuthToken = in.AuthToken
...
// Convert_kops_RegistryMirrorAuthConfig_To_v1alpha3_RegistryMirrorAuthConfig is an autogenerated conversion function.
func Convert_kops_RegistryMirrorAuthConfig_To_v1alpha3_RegistryMirrorAuthConfig(in *kops.RegistryMirrorAuthConfig, out *RegistryMirrorAuthConfig, s conversion.Scope) error {
	return autoConvert_kops_RegistryMirrorAuthConfig_To_v1alpha3_RegistryMirrorAuthConfig(in, out, s)
}
