...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*MemorySwapConfiguration)(nil), (*kops.MemorySwapConfiguration)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha3_MemorySwapConfiguration_To_kops_MemorySwapConfiguration(a.(*MemorySwapConfiguration), b.(*kops.MemorySwapConfiguration), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*kops.MemorySwapConfiguration)(nil), (*MemorySwapConfiguration)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_kops_MemorySwapConfiguration_To_v1alpha3_MemorySwapConfiguration(a.(*kops.MemorySwapConfiguration), b.(*MemorySwapConfiguration), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha3_KubeletConfigSpec_To_kops_KubeletConfigSpec(in *KubeletConfigSpec, out *kops.KubeletConfigSpec, s conversion.Scope) error {
	...
	if in.MemorySwapConfiguration != nil {
		in, out := &in.MemorySwapConfiguration, &out.MemorySwapConfiguration
		*out = new(kops.MemorySwapConfiguration)
		if err := Convert_v1alpha3_MemorySwapConfiguration_To_kops_MemorySwapConfiguration(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.MemorySwapConfiguration = nil
	}
...
func autoConvert_kops_KubeletConfigSpec_To_v1alpha3_KubeletConfigSpec(in *kops.KubeletConfigSpec, out *KubeletConfigSpec, s conversion.Scope) error {
	...
	if in.MemorySwapConfiguration != nil {
		...
		*out = new(MemorySwapConfiguration)
		if err := Convert_kops_MemorySwapConfiguration_To_v1alpha3_MemorySwapConfiguration(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.MemorySwapConfiguration = nil
...
func autoConvert_v1alpha3_MemorySwapConfiguration_To_kops_MemorySwapConfiguration(in *MemorySwapConfiguration, out *kops.MemorySwapConfiguration, s conversion.Scope) error {
	out.SwapBehavior = in.SwapBehavior
	return nil
}

// Convert_v1alpha3_MemorySwapConfiguration_To_kops_MemorySwapConfiguration is an autogenerated conversion function.
func Convert_v1alpha3_MemorySwapConfiguration_To_kops_MemorySwapConfiguration(in *MemorySwapConfiguration, out *kops.MemorySwapConfiguration, s conversion.Scope) error {
	return autoConvert_v1alpha3_MemorySwapConfiguration_To_kops_MemorySwapConfiguration(in, out, s)
}

func autoConvert_kops_MemorySwapConfiguration_To_v1alpha3_MemorySwapConfiguration(in *kops.MemorySwapConfiguration, out *MemorySwapConfiguration, s conversion.Scope) error {
	out.SwapBehavior = in.SwapBehavior
	return nil
}

// Convert_kops_MemorySwapConfiguration_To_v1alpha3_MemorySwapConfiguration is an autogenerated conversion function.
func Convert_kops_MemorySwapConfiguration_To_v1alpha3_MemorySwapConfiguration(in *kops.MemorySwapConfiguration, out *MemorySwapConfiguration, s conversion.Scope) error {
	return autoConvert_kops_MemorySwapConfiguration_To_v1alpha3_MemorySwapConfiguration(in, out, s)
}
