...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*KarpenterDisruption)(nil), (*kops.KarpenterDisruption)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha3_KarpenterDisruption_To_kops_KarpenterDisruption(a.(*KarpenterDisruption), b.(*kops.KarpenterDisruption), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*kops.KarpenterDisruption)(nil), (*KarpenterDisruption)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_kops_KarpenterDisruption_To_v1alpha3_KarpenterDisruption(a.(*kops.KarpenterDisruption), b.(*KarpenterDisruption), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha3_KarpenterConfig_To_kops_KarpenterConfig(in *KarpenterConfig, out *kops.KarpenterConfig, s conversion.Scope) error {
	...
	if in.Disruption != nil {
		...
		*out = new(kops.KarpenterDisruption)
		if err := Convert_v1alpha3_KarpenterDisruption_To_kops_KarpenterDisruption(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.Disruption = nil
...
func autoConvert_kops_KarpenterConfig_To_v1alpha3_KarpenterConfig(in *kops.KarpenterConfig, out *KarpenterConfig, s conversion.Scope) error {
	...
	if in.Disruption != nil {
		in, out := &in.Disruption, &out.Disruption
		*out = new(KarpenterDisruption)
		if err := Convert_kops_KarpenterDisruption_To_v1alpha3_KarpenterDisruption(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.Disruption = nil
...
func autoConvert_v1alpha3_KarpenterDisruption_To_kops_KarpenterDisruption(in *KarpenterDisruption, out *kops.KarpenterDisruption, s conversion.Scope) error {
	out.ConsolidationPolicy = in.ConsolidationPolicy
	out.ConsolidateAfter = in.ConsolidateAfter
	out.ExpireAfter = in.ExpireAfter
	return nil
}

// Convert_v1alpha3_KarpenterDisruption_To_kops_KarpenterDisruption is an autogenerated conversion function.
func Convert_v1alpha3_KarpenterDisruption_To_kops_KarpenterDisruption(in *KarpenterDisruption, out *kops.KarpenterDisruption, s conversion.Scope) error {
	return autoConvert_v1alpha3_KarpenterDisruption_To_kops_KarpenterDisruption(in, out, s)
}

func autoConvert_kops_KarpenterDisruption_To_v1alpha3_KarpenterDisruption(in *kops.KarpenterDisruption, out *KarpenterDisruption, s conversion.Scope) error {
	out.ConsolidationPolicy = in.ConsolidationPolicy
	out.ConsolidateAfter = in.ConsolidateAfter
	out.ExpireAfter = in.ExpireAfter
	return nil
...
// Convert_kops_KarpenterDisruption_To_v1alpha3_KarpenterDisruption is an autogenerated conversion function.
func Convert_kops_KarpenterDisruption_To_v1alpha3_KarpenterDisruption(in *kops.KarpenterDisruption, out *KarpenterDisruption, s conversion.Scope) error {
	return autoConvert_kops_KarpenterDisruption_To_v1alpha3_KarpenterDisruption(in, out, s)
}
