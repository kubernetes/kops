...
func (in *ClusterSpec) DeepCopyInto(out *ClusterSpec) {
	*out = *in
	...
	if in.IAMRolesForServiceAccounts != nil {
		in, out := &in.IAMRolesForServiceAccounts, &out.IAMRolesForServiceAccounts
		*out = new(IAMRolesForServiceAccountsConfig)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IAMRolesForServiceAccountsConfig) DeepCopyInto(out *IAMRolesForServiceAccountsConfig) {
	*out = *in
	if in.ServiceAccounts != nil {
		in, out := &in.ServiceAccounts, &out.ServiceAccounts
		*out = make([]ServiceAccountMapping, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IAMRolesForServiceAccountsConfig.
func (in *IAMRolesForServiceAccountsConfig) DeepCopy() *IAMRolesForServiceAccountsConfig {
	if in == nil {
		return nil
	}
	out := new(IAMRolesForServiceAccountsConfig)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServiceAccountMapping) DeepCopyInto(out *ServiceAccountMapping) {
	*out = *in
	if in.IAMPolicyARNs != nil {
		in, out := &in.IAMPolicyARNs, &out.IAMPolicyARNs
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServiceAccountMapping.
func (in *ServiceAccountMapping) DeepCopy() *ServiceAccountMapping {
	if in == nil {
		return nil
	}
	out := new(ServiceAccountMapping)
	in.DeepCopyInto(out)
	return out
}
