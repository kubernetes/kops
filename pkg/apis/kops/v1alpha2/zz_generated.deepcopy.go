...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterAutoscalerServiceMonitorConfig) DeepCopyInto(out *ClusterAutoscalerServiceMonitorConfig) {
	*out = *in
	if in.Enabled != nil {
		in, out := &in.Enabled, &out.Enabled
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterAutoscalerServiceMonitorConfig.
func (in *ClusterAutoscalerServiceMonitorConfig) DeepCopy() *ClusterAutoscalerServiceMonitorConfig {
	if in == nil {
		return nil
	}
	out := new(ClusterAutoscalerServiceMonitorConfig)
