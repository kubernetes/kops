...
func (in *NodeAuthorizerSpec) DeepCopyInto(out *NodeAuthorizerSpec) {
	*out = *in
	if in.EnableAddressCheck != nil {
		in, out := &in.EnableAddressCheck, &out.EnableAddressCheck
		if *in == nil {
			*out = nil
		} else {
			*out = new(bool)
	...
	if in.EnableRegistrationCheck != nil {
		in, out := &in.EnableRegistrationCheck, &out.EnableRegistrationCheck
		if *in == nil {
			*out = nil
		} else {
			*out = new(bool)
