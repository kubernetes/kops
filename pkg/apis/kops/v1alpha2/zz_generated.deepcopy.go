...
func (in *SecurityGroups) DeepCopyInto(out *SecurityGroups) {
	*out = *in
	if in.MasterGroups != nil {
		in, out := &in.MasterGroups, &out.MasterGroups
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	...
	if in.BastionGroups != nil {
		in, out := &in.BastionGroups, &out.BastionGroups
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.BastionELBGroups != nil {
		in, out := &in.BastionELBGroups, &out.BastionELBGroups
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	return
