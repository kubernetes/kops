...
func autoConvert_v1alpha2_Ext4FileSystemSpec_To_kops_Ext4FileSystemSpec(in *Ext4FileSystemSpec, out *kops.Ext4FileSystemSpec, s conversion.Scope) error {
	return nil
}

// Convert_v1alpha2_Ext4FileSystemSpec_To_kops_Ext4FileSystemSpec is an autogenerated conversion function.
func Convert_v1alpha2_Ext4FileSystemSpec_To_kops_Ext4FileSystemSpec(in *Ext4FileSystemSpec, out *kops.Ext4FileSystemSpec, s conversion.Scope) error {
	return autoConvert_v1alpha2_Ext4FileSystemSpec_To_kops_Ext4FileSystemSpec(in, out, s)
}

func autoConvert_kops_Ext4FileSystemSpec_To_v1alpha2_Ext4FileSystemSpec(in *kops.Ext4FileSystemSpec, out *Ext4FileSystemSpec, s conversion.Scope) error {
	return nil
}

// Convert_kops_Ext4FileSystemSpec_To_v1alpha2_Ext4FileSystemSpec is an autogenerated conversion function.
func Convert_kops_Ext4FileSystemSpec_To_v1alpha2_Ext4FileSystemSpec(in *kops.Ext4FileSystemSpec, out *Ext4FileSystemSpec, s conversion.Scope) error {
	return autoConvert_kops_Ext4FileSystemSpec_To_v1alpha2_Ext4FileSystemSpec(in, out, s)
}
...
func autoConvert_v1alpha2_InstanceGroupVolumeFilesystemSpec_To_kops_InstanceGroupVolumeFilesystemSpec(in *InstanceGroupVolumeFilesystemSpec, out *kops.InstanceGroupVolumeFilesystemSpec, s conversion.Scope) error {
	if in.Ext4 != nil {
		in, out := &in.Ext4, &out.Ext4
		*out = new(kops.Ext4FileSystemSpec)
		if err := Convert_v1alpha2_Ext4FileSystemSpec_To_kops_Ext4FileSystemSpec(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.Ext4 = nil
...
// Convert_v1alpha2_InstanceGroupVolumeFilesystemSpec_To_kops_InstanceGroupVolumeFilesystemSpec is an autogenerated conversion function.
func Convert_v1alpha2_InstanceGroupVolumeFilesystemSpec_To_kops_InstanceGroupVolumeFilesystemSpec(in *InstanceGroupVolumeFilesystemSpec, out *kops.InstanceGroupVolumeFilesystemSpec, s conversion.Scope) error {
	return autoConvert_v1alpha2_InstanceGroupVolumeFilesystemSpec_To_kops_InstanceGroupVolumeFilesystemSpec(in, out, s)
}

func autoConvert_kops_InstanceGroupVolumeFilesystemSpec_To_v1alpha2_InstanceGroupVolumeFilesystemSpec(in *kops.InstanceGroupVolumeFilesystemSpec, out *InstanceGroupVolumeFilesystemSpec, s conversion.Scope) error {
	if in.Ext4 != nil {
		in, out := &in.Ext4, &out.Ext4
		*out = new(Ext4FileSystemSpec)
		if err := Convert_kops_Ext4FileSystemSpec_To_v1alpha2_Ext4FileSystemSpec(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.Ext4 = nil
...
// Convert_kops_InstanceGroupVolumeFilesystemSpec_To_v1alpha2_InstanceGroupVolumeFilesystemSpec is an autogenerated conversion function.
func Convert_kops_InstanceGroupVolumeFilesystemSpec_To_v1alpha2_InstanceGroupVolumeFilesystemSpec(in *kops.InstanceGroupVolumeFilesystemSpec, out *InstanceGroupVolumeFilesystemSpec, s conversion.Scope) error {
	return autoConvert_kops_InstanceGroupVolumeFilesystemSpec_To_v1alpha2_InstanceGroupVolumeFilesystemSpec(in, out, s)
}

func autoConvert_v1alpha2_InstanceGroupVolumeSpec_To_kops_InstanceGroupVolumeSpec(in *InstanceGroupVolumeSpec, out *kops.InstanceGroupVolumeSpec, s conversion.Scope) error {
	...
	if in.Filesystem != nil {
		...
		*out = new(kops.InstanceGroupVolumeFilesystemSpec)
		if err := Convert_v1alpha2_InstanceGroupVolumeFilesystemSpec_To_kops_InstanceGroupVolumeFilesystemSpec(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.Filesystem = nil
...
// Convert_v1alpha2_InstanceGroupVolumeSpec_To_kops_InstanceGroupVolumeSpec is an autogenerated conversion function.
func Convert_v1alpha2_InstanceGroupVolumeSpec_To_kops_InstanceGroupVolumeSpec(in *InstanceGroupVolumeSpec, out *kops.InstanceGroupVolumeSpec, s conversion.Scope) error {
	return autoConvert_v1alpha2_InstanceGroupVolumeSpec_To_kops_InstanceGroupVolumeSpec(in, out, s)
}

func autoConvert_kops_InstanceGroupVolumeSpec_To_v1alpha2_InstanceGroupVolumeSpec(in *kops.InstanceGroupVolumeSpec, out *InstanceGroupVolumeSpec, s conversion.Scope) error {
	out.DeviceName = in.DeviceName
	out.Encrypted = in.Encrypted
	if in.Filesystem != nil {
		in, out := &in.Filesystem, &out.Filesystem
		*out = new(InstanceGroupVolumeFilesystemSpec)
		if err := Convert_kops_InstanceGroupVolumeFilesystemSpec_To_v1alpha2_InstanceGroupVolumeFilesystemSpec(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.Filesystem = nil
...
// Convert_kops_InstanceGroupVolumeSpec_To_v1alpha2_InstanceGroupVolumeSpec is an autogenerated conversion function.
func Convert_kops_InstanceGroupVolumeSpec_To_v1alpha2_InstanceGroupVolumeSpec(in *kops.InstanceGroupVolumeSpec, out *InstanceGroupVolumeSpec, s conversion.Scope) error {
	return autoConvert_kops_InstanceGroupVolumeSpec_To_v1alpha2_InstanceGroupVolumeSpec(in, out, s)
}
