...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1alpha2_KeyItem_To_kops_KeyItem,
		Convert_kops_KeyItem_To_v1alpha2_KeyItem,
...
func autoConvert_v1alpha2_KeyItem_To_kops_KeyItem(in *KeyItem, out *kops.KeyItem, s conversion.Scope) error {
	out.Id = in.Id
...
// Convert_v1alpha2_KeyItem_To_kops_KeyItem is an autogenerated conversion function.
func Convert_v1alpha2_KeyItem_To_kops_KeyItem(in *KeyItem, out *kops.KeyItem, s conversion.Scope) error {
	return autoConvert_v1alpha2_KeyItem_To_kops_KeyItem(in, out, s)
}

func autoConvert_kops_KeyItem_To_v1alpha2_KeyItem(in *kops.KeyItem, out *KeyItem, s conversion.Scope) error {
	out.Id = in.Id
	if err := conversion.Convert_Slice_byte_To_Slice_byte(&in.PublicMaterial, &out.PublicMaterial, s); err != nil {
		return err
	}
...
// Convert_kops_KeyItem_To_v1alpha2_KeyItem is an autogenerated conversion function.
func Convert_kops_KeyItem_To_v1alpha2_KeyItem(in *kops.KeyItem, out *KeyItem, s conversion.Scope) error {
	return autoConvert_kops_KeyItem_To_v1alpha2_KeyItem(in, out, s)
}
...
func autoConvert_v1alpha2_KeysetSpec_To_kops_KeysetSpec(in *KeysetSpec, out *kops.KeysetSpec, s conversion.Scope) error {
	...
	if in.Keys != nil {
		...
		*out = make([]kops.KeyItem, len(*in))
		for i := range *in {
			if err := Convert_v1alpha2_KeyItem_To_kops_KeyItem(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_kops_KeysetSpec_To_v1alpha2_KeysetSpec(in *kops.KeysetSpec, out *KeysetSpec, s conversion.Scope) error {
	...
	if in.Keys != nil {
		...
		*out = make([]KeyItem, len(*in))
		for i := range *in {
			if err := Convert_kops_KeyItem_To_v1alpha2_KeyItem(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
