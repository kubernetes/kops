...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*ClusterAutoscalerServiceMonitorConfig)(nil), (*kops.ClusterAutoscalerServiceMonitorConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha2_ClusterAutoscalerServiceMonitorConfig_To_kops_ClusterAutoscalerServiceMonitorConfig(a.(*ClusterAutoscalerServiceMonitorConfig), b.(*kops.ClusterAutoscalerServiceMonitorConfig), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*kops.ClusterAutoscalerServiceMonitorConfig)(nil), (*ClusterAutoscalerServiceMonitorConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_kops_ClusterAutoscalerServiceMonitorConfig_To_v1alpha2_ClusterAutoscalerServiceMonitorConfig(a.(*kops.ClusterAutoscalerServiceMonitorConfig), b.(*ClusterAutoscalerServiceMonitorConfig), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha2_ClusterAutoscalerConfig_To_kops_ClusterAutoscalerConfig(in *ClusterAutoscalerConfig, out *kops.ClusterAutoscalerConfig, s conversion.Scope) error {
	...
	if in.ServiceMonitor != nil {
		...
		*out = new(kops.ClusterAutoscalerServiceMonitorConfig)
		if err := Convert_v1alpha2_ClusterAutoscalerServiceMonitorConfig_To_kops_ClusterAutoscalerServiceMonitorConfig(*in, *out, s); err != nil {
			return err
		}
	} else {
...
func autoConvert_kops_ClusterAutoscalerConfig_To_v1alpha2_ClusterAutoscalerConfig(in *kops.ClusterAutoscalerConfig, out *ClusterAutoscalerConfig, s conversion.Scope) error {
	...
	if in.ServiceMonitor != nil {
		...
		*out = new(ClusterAutoscalerServiceMonitorConfig)
		if err := Convert_kops_ClusterAutoscalerServiceMonitorConfig_To_v1alpha2_ClusterAutoscalerServiceMonitorConfig(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.ServiceMonitor = nil
...
func autoConvert_v1alpha2_ClusterAutoscalerServiceMonitorConfig_To_kops_ClusterAutoscalerServiceMonitorConfig(in *ClusterAutoscalerServiceMonitorConfig, out *kops.ClusterAutoscalerServiceMonitorConfig, s conversion.Scope) error {
	out.Enabled = in.Enabled
...
// Convert_v1alpha2_ClusterAutoscalerServiceMonitorConfig_To_kops_ClusterAutoscalerServiceMonitorConfig is an autogenerated conversion function.
func Convert_v1alpha2_ClusterAutoscalerServiceMonitorConfig_To_kops_ClusterAutoscalerServiceMonitorConfig(in *ClusterAutoscalerServiceMonitorConfig, out *kops.ClusterAutoscalerServiceMonitorConfig, s conversion.Scope) error {
	return autoConvert_v1alpha2_ClusterAutoscalerServiceMonitorConfig_To_kops_ClusterAutoscalerServiceMonitorConfig(in, out, s)
}

func autoConvert_kops_ClusterAutoscalerServiceMonitorConfig_To_v1alpha2_ClusterAutoscalerServiceMonitorConfig(in *kops.ClusterAutoscalerServiceMonitorConfig, out *ClusterAutoscalerServiceMonitorConfig, s conversion.Scope) error {
	out.Enabled = in.Enabled
	out.Namespace = in.Namespace
	out.ScrapeInterval = in.ScrapeInterval
	return nil
...
// Convert_kops_ClusterAutoscalerServiceMonitorConfig_To_v1alpha2_ClusterAutoscalerServiceMonitorConfig is an autogenerated conversion function.
func Convert_kops_ClusterAutoscalerServiceMonitorConfig_To_v1alpha2_ClusterAutoscalerServiceMonitorConfig(in *kops.ClusterAutoscalerServiceMonitorConfig, out *ClusterAutoscalerServiceMonitorConfig, s conversion.Scope) error {
	return autoConvert_kops_ClusterAutoscalerServiceMonitorConfig_To_v1alpha2_ClusterAutoscalerServiceMonitorConfig(in, out, s)
}
