...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*IAMRolesForServiceAccountsConfig)(nil), (*kops.IAMRolesForServiceAccountsConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha2_IAMRolesForServiceAccountsConfig_To_kops_IAMRolesForServiceAccountsConfig(a.(*IAMRolesForServiceAccountsConfig), b.(*kops.IAMRolesForServiceAccountsConfig), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*kops.IAMRolesForServiceAccountsConfig)(nil), (*IAMRolesForServiceAccountsConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_kops_IAMRolesForServiceAccountsConfig_To_v1alpha2_IAMRolesForServiceAccountsConfig(a.(*kops.IAMRolesForServiceAccountsConfig), b.(*IAMRolesForServiceAccountsConfig), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*ServiceAccountMapping)(nil), (*kops.ServiceAccountMapping)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha2_ServiceAccountMapping_To_kops_ServiceAccountMapping(a.(*ServiceAccountMapping), b.(*kops.ServiceAccountMapping), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*kops.ServiceAccountMapping)(nil), (*ServiceAccountMapping)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_kops_ServiceAccountMapping_To_v1alpha2_ServiceAccountMapping(a.(*kops.ServiceAccountMapping), b.(*ServiceAccountMapping), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha2_ClusterSpec_To_kops_ClusterSpec(in *ClusterSpec, out *kops.ClusterSpec, s conversion.Scope) error {
	...
	if in.IAMRolesForServiceAccounts != nil {
		...
		*out = new(kops.IAMRolesForServiceAccountsConfig)
		if err := Convert_v1alpha2_IAMRolesForServiceAccountsConfig_To_kops_IAMRolesForServiceAccountsConfig(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.IAMRolesForServiceAccounts = nil
	}
	return nil
}
...
func autoConvert_kops_ClusterSpec_To_v1alpha2_ClusterSpec(in *kops.ClusterSpec, out *ClusterSpec, s conversion.Scope) error {
	...
	if in.IAMRolesForServiceAccounts != nil {
		...
		*out = new(IAMRolesForServiceAccountsConfig)
		if err := Convert_kops_IAMRolesForServiceAccountsConfig_To_v1alpha2_IAMRolesForServiceAccountsConfig(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.IAMRolesForServiceAccounts = nil
...
func autoConvert_v1alpha2_IAMRolesForServiceAccountsConfig_To_kops_IAMRolesForServiceAccountsConfig(in *IAMRolesForServiceAccountsConfig, out *kops.IAMRolesForServiceAccountsConfig, s conversion.Scope) error {
	if in.ServiceAccounts != nil {
		...
		*out = make([]kops.ServiceAccountMapping, len(*in))
		for i := range *in {
			if err := Convert_v1alpha2_ServiceAccountMapping_To_kops_ServiceAccountMapping(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
// Convert_v1alpha2_IAMRolesForServiceAccountsConfig_To_kops_IAMRolesForServiceAccountsConfig is an autogenerated conversion function.
func Convert_v1alpha2_IAMRolesForServiceAccountsConfig_To_kops_IAMRolesForServiceAccountsConfig(in *IAMRolesForServiceAccountsConfig, out *kops.IAMRolesForServiceAccountsConfig, s conversion.Scope) error {
	return autoConvert_v1alpha2_IAMRolesForServiceAccountsConfig_To_kops_IAMRolesForServiceAccountsConfig(in, out, s)
}
...
func autoConvert_kops_IAMRolesForServiceAccountsConfig_To_v1alpha2_IAMRolesForServiceAccountsConfig(in *kops.IAMRolesForServiceAccountsConfig, out *IAMRolesForServiceAccountsConfig, s conversion.Scope) error {
	if in.ServiceAccounts != nil {
		...
		*out = make([]ServiceAccountMapping, len(*in))
		for i := range *in {
			if err := Convert_kops_ServiceAccountMapping_To_v1alpha2_ServiceAccountMapping(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
// Convert_kops_IAMRolesForServiceAccountsConfig_To_v1alpha2_IAMRolesForServiceAccountsConfig is an autogenerated conversion function.
func Convert_kops_IAMRolesForServiceAccountsConfig_To_v1alpha2_IAMRolesForServiceAccountsConfig(in *kops.IAMRolesForServiceAccountsConfig, out *IAMRolesForServiceAccountsConfig, s conversion.Scope) error {
	return autoConvert_kops_IAMRolesForServiceAccountsConfig_To_v1alpha2_IAMRolesForServiceAccountsConfig(in, out, s)
}
...
func autoConvert_v1alpha2_ServiceAccountMapping_To_kops_ServiceAccountMapping(in *ServiceAccountMapping, out *kops.ServiceAccountMapping, s conversion.Scope) error {
	out.Name = in.Name
	out.Namespace = in.Namespace
	out.IAMPolicyARNs = in.IAMPolicyARNs
	out.InlinePolicy = in.InlinePolicy
	return nil
}

// Convert_v1alpha2_ServiceAccountMapping_To_kops_ServiceAccountMapping is an autogenerated conversion function.
func Convert_v1alpha2_ServiceAccountMapping_To_kops_ServiceAccountMapping(in *ServiceAccountMapping, out *kops.ServiceAccountMapping, s conversion.Scope) error {
	return autoConvert_v1alpha2_ServiceAccountMapping_To_kops_ServiceAccountMapping(in, out, s)
}

func autoConvert_kops_ServiceAccountMapping_To_v1alpha2_ServiceAccountMapping(in *kops.ServiceAccountMapping, out *ServiceAccountMapping, s conversion.Scope) error {
	out.Name = in.Name
	out.Namespace = in.Namespace
	out.IAMPolicyARNs = in.IAMPolicyARNs
	out.InlinePolicy = in.InlinePolicy
...
// Convert_kops_ServiceAccountMapping_To_v1alpha2_ServiceAccountMapping is an autogenerated conversion function.
func Convert_kops_ServiceAccountMapping_To_v1alpha2_ServiceAccountMapping(in *kops.ServiceAccountMapping, out *ServiceAccountMapping, s conversion.Scope) error {
	return autoConvert_kops_ServiceAccountMapping_To_v1alpha2_ServiceAccountMapping(in, out, s)
}
