...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1alpha2_EgressSpec_To_kops_EgressSpec,
		Convert_kops_EgressSpec_To_v1alpha2_EgressSpec,
...
func autoConvert_v1alpha2_ClusterSubnetSpec_To_kops_ClusterSubnetSpec(in *ClusterSubnetSpec, out *kops.ClusterSubnetSpec, s conversion.Scope) error {
	...
	if in.Egress != nil {
		...
		*out = make([]kops.EgressSpec, len(*in))
		for i := range *in {
			if err := Convert_v1alpha2_EgressSpec_To_kops_EgressSpec(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_kops_ClusterSubnetSpec_To_v1alpha2_ClusterSubnetSpec(in *kops.ClusterSubnetSpec, out *ClusterSubnetSpec, s conversion.Scope) error {
	...
	if in.Egress != nil {
		...
		*out = make([]EgressSpec, len(*in))
		for i := range *in {
			if err := Convert_kops_EgressSpec_To_v1alpha2_EgressSpec(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_v1alpha2_EgressSpec_To_kops_EgressSpec(in *EgressSpec, out *kops.EgressSpec, s conversion.Scope) error {
	out.CIDR = in.CIDR
...
// Convert_v1alpha2_EgressSpec_To_kops_EgressSpec is an autogenerated conversion function.
func Convert_v1alpha2_EgressSpec_To_kops_EgressSpec(in *EgressSpec, out *kops.EgressSpec, s conversion.Scope) error {
	return autoConvert_v1alpha2_EgressSpec_To_kops_EgressSpec(in, out, s)
}

func autoConvert_kops_EgressSpec_To_v1alpha2_EgressSpec(in *kops.EgressSpec, out *EgressSpec, s conversion.Scope) error {
	out.CIDR = in.CIDR
	out.NatGateway = in.NatGateway
	out.Instance = in.Instance
	out.VpcPeeringConnection = in.VpcPeeringConnection
...
// Convert_kops_EgressSpec_To_v1alpha2_EgressSpec is an autogenerated conversion function.
func Convert_kops_EgressSpec_To_v1alpha2_EgressSpec(in *kops.EgressSpec, out *EgressSpec, s conversion.Scope) error {
	return autoConvert_kops_EgressSpec_To_v1alpha2_EgressSpec(in, out, s)
}
