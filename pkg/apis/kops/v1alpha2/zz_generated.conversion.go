...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*DiscoverySpec)(nil), (*kops.DiscoverySpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha2_DiscoverySpec_To_kops_DiscoverySpec(a.(*DiscoverySpec), b.(*kops.DiscoverySpec), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*kops.DiscoverySpec)(nil), (*DiscoverySpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_kops_DiscoverySpec_To_v1alpha2_DiscoverySpec(a.(*kops.DiscoverySpec), b.(*DiscoverySpec), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha2_ClusterSpec_To_kops_ClusterSpec(in *ClusterSpec, out *kops.ClusterSpec, s conversion.Scope) error {
	...
	if in.Discovery != nil {
		...
		*out = new(kops.DiscoverySpec)
		if err := Convert_v1alpha2_DiscoverySpec_To_kops_DiscoverySpec(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.Discovery = nil
...
func autoConvert_kops_ClusterSpec_To_v1alpha2_ClusterSpec(in *kops.ClusterSpec, out *ClusterSpec, s conversion.Scope) error {
	...
	if in.Discovery != nil {
		...
		*out = new(DiscoverySpec)
		if err := Convert_kops_DiscoverySpec_To_v1alpha2_DiscoverySpec(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.Discovery = nil
...
func autoConvert_v1alpha2_DiscoverySpec_To_kops_DiscoverySpec(in *DiscoverySpec, out *kops.DiscoverySpec, s conversion.Scope) error {
	out.Base = in.Base
	return nil
}

// Convert_v1alpha2_DiscoverySpec_To_kops_DiscoverySpec is an autogenerated conversion function.
func Convert_v1alpha2_DiscoverySpec_To_kops_DiscoverySpec(in *DiscoverySpec, out *kops.DiscoverySpec, s conversion.Scope) error {
	return autoConvert_v1alpha2_DiscoverySpec_To_kops_DiscoverySpec(in, out, s)
}

func autoConvert_kops_DiscoverySpec_To_v1alpha2_DiscoverySpec(in *kops.DiscoverySpec, out *DiscoverySpec, s conversion.Scope) error {
	out.Base = in.Base
	return nil
}

// Convert_kops_DiscoverySpec_To_v1alpha2_DiscoverySpec is an autogenerated conversion function.
func Convert_kops_DiscoverySpec_To_v1alpha2_DiscoverySpec(in *kops.DiscoverySpec, out *DiscoverySpec, s conversion.Scope) error {
	return autoConvert_kops_DiscoverySpec_To_v1alpha2_DiscoverySpec(in, out, s)
}
