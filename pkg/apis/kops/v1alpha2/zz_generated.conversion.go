...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*CPUOptionsSpec)(nil), (*kops.CPUOptionsSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha2_CPUOptionsSpec_To_kops_CPUOptionsSpec(a.(*CPUOptionsSpec), b.(*kops.CPUOptionsSpec), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*kops.CPUOptionsSpec)(nil), (*CPUOptionsSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_kops_CPUOptionsSpec_To_v1alpha2_CPUOptionsSpec(a.(*kops.CPUOptionsSpec), b.(*CPUOptionsSpec), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha2_CPUOptionsSpec_To_kops_CPUOptionsSpec(in *CPUOptionsSpec, out *kops.CPUOptionsSpec, s conversion.Scope) error {
...
// Convert_v1alpha2_CPUOptionsSpec_To_kops_CPUOptionsSpec is an autogenerated conversion function.
func Convert_v1alpha2_CPUOptionsSpec_To_kops_CPUOptionsSpec(in *CPUOptionsSpec, out *kops.CPUOptionsSpec, s conversion.Scope) error {
	return autoConvert_v1alpha2_CPUOptionsSpec_To_kops_CPUOptionsSpec(in, out, s)
}

func autoConvert_kops_CPUOptionsSpec_To_v1alpha2_CPUOptionsSpec(in *kops.CPUOptionsSpec, out *CPUOptionsSpec, s conversion.Scope) error {
	out.CoreCount = in.CoreCount
	out.ThreadsPerCore = in.ThreadsPerCore
	out.AmdSevSnp = in.AmdSevSnp
	return nil
...
// Convert_kops_CPUOptionsSpec_To_v1alpha2_CPUOptionsSpec is an autogenerated conversion function.
func Convert_kops_CPUOptionsSpec_To_v1alpha2_CPUOptionsSpec(in *kops.CPUOptionsSpec, out *CPUOptionsSpec, s conversion.Scope) error {
	return autoConvert_kops_CPUOptionsSpec_To_v1alpha2_CPUOptionsSpec(in, out, s)
}
...
func autoConvert_v1alpha2_InstanceGroupSpec_To_kops_InstanceGroupSpec(in *InstanceGroupSpec, out *kops.InstanceGroupSpec, s conversion.Scope) error {
	...
	if in.CPUOptions != nil {
		...
		*out = new(kops.CPUOptionsSpec)
		if err := Convert_v1alpha2_CPUOptionsSpec_To_kops_CPUOptionsSpec(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.CPUOptions = nil
...
func autoConvert_kops_InstanceGroupSpec_To_v1alpha2_InstanceGroupSpec(in *kops.InstanceGroupSpec, out *InstanceGroupSpec, s conversion.Scope) error {
	...
	if in.CPUOptions != nil {
		...
		*out = new(CPUOptionsSpec)
		if err := Convert_kops_CPUOptionsSpec_To_v1alpha2_CPUOptionsSpec(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.CPUOptions = nil
