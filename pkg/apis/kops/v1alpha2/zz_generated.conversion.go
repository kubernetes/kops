...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*SSHAccessSpec)(nil), (*kops.SSHAccessSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha2_SSHAccessSpec_To_kops_SSHAccessSpec(a.(*SSHAccessSpec), b.(*kops.SSHAccessSpec), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*kops.SSHAccessSpec)(nil), (*SSHAccessSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_kops_SSHAccessSpec_To_v1alpha2_SSHAccessSpec(a.(*kops.SSHAccessSpec), b.(*SSHAccessSpec), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha2_ClusterSpec_To_kops_ClusterSpec(in *ClusterSpec, out *kops.ClusterSpec, s conversion.Scope) error {
	...
	if in.SSHAccess != nil {
		...
		*out = new(kops.SSHAccessSpec)
		if err := Convert_v1alpha2_SSHAccessSpec_To_kops_SSHAccessSpec(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.SSHAccess = nil
...
func autoConvert_kops_ClusterSpec_To_v1alpha2_ClusterSpec(in *kops.ClusterSpec, out *ClusterSpec, s conversion.Scope) error {
	...
	if in.SSHAccess != nil {
		...
		*out = new(SSHAccessSpec)
		if err := Convert_kops_SSHAccessSpec_To_v1alpha2_SSHAccessSpec(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.SSHAccess = nil
...
// Convert_v1alpha2_SSHAccessSpec_To_kops_SSHAccessSpec is an autogenerated conversion function.
func Convert_v1alpha2_SSHAccessSpec_To_kops_SSHAccessSpec(in *SSHAccessSpec, out *kops.SSHAccessSpec, s conversion.Scope) error {
	return autoConvert_v1alpha2_SSHAccessSpec_To_kops_SSHAccessSpec(in, out, s)
}
...
// Convert_kops_SSHAccessSpec_To_v1alpha2_SSHAccessSpec is an autogenerated conversion function.
func Convert_kops_SSHAccessSpec_To_v1alpha2_SSHAccessSpec(in *kops.SSHAccessSpec, out *SSHAccessSpec, s conversion.Scope) error {
	return autoConvert_kops_SSHAccessSpec_To_v1alpha2_SSHAccessSpec(in, out, s)
}
