...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*OIDCIssuerConfig)(nil), (*kops.OIDCIssuerConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha2_OIDCIssuerConfig_To_kops_OIDCIssuerConfig(a.(*OIDCIssuerConfig), b.(*kops.OIDCIssuerConfig), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*kops.OIDCIssuerConfig)(nil), (*OIDCIssuerConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_kops_OIDCIssuerConfig_To_v1alpha2_OIDCIssuerConfig(a.(*kops.OIDCIssuerConfig), b.(*OIDCIssuerConfig), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha2_ClusterSpec_To_kops_ClusterSpec(in *ClusterSpec, out *kops.ClusterSpec, s conversion.Scope) error {
	...
	if in.ServiceAccountIssuerDiscovery != nil {
		...
		*out = new(kops.OIDCIssuerConfig)
		if err := Convert_v1alpha2_OIDCIssuerConfig_To_kops_OIDCIssuerConfig(*in, *out, s); err != nil {
			return err
		}
	} else {
...
func autoConvert_kops_ClusterSpec_To_v1alpha2_ClusterSpec(in *kops.ClusterSpec, out *ClusterSpec, s conversion.Scope) error {
	...
	if in.ServiceAccountIssuerDiscovery != nil {
		...
		*out = new(OIDCIssuerConfig)
		if err := Convert_kops_OIDCIssuerConfig_To_v1alpha2_OIDCIssuerConfig(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.ServiceAccountIssuerDiscovery = nil
...
// Convert_v1alpha2_OIDCIssuerConfig_To_kops_OIDCIssuerConfig is an autogenerated conversion function.
func Convert_v1alpha2_OIDCIssuerConfig_To_kops_OIDCIssuerConfig(in *OIDCIssuerConfig, out *kops.OIDCIssuerConfig, s conversion.Scope) error {
	return autoConvert_v1alpha2_OIDCIssuerConfig_To_kops_OIDCIssuerConfig(in, out, s)
}
...
// Convert_kops_OIDCIssuerConfig_To_v1alpha2_OIDCIssuerConfig is an autogenerated conversion function.
func Convert_kops_OIDCIssuerConfig_To_v1alpha2_OIDCIssuerConfig(in *kops.OIDCIssuerConfig, out *OIDCIssuerConfig, s conversion.Scope) error {
	return autoConvert_kops_OIDCIssuerConfig_To_v1alpha2_OIDCIssuerConfig(in, out, s)
}
