...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1alpha2_Secret_To_kops_Secret,
		Convert_kops_Secret_To_v1alpha2_Secret,
		Convert_v1alpha2_SecretList_To_kops_SecretList,
		Convert_kops_SecretList_To_v1alpha2_SecretList,
		Convert_v1alpha2_SecretSpec_To_kops_SecretSpec,
		Convert_kops_SecretSpec_To_v1alpha2_SecretSpec,
...
func autoConvert_v1alpha2_Secret_To_kops_Secret(in *Secret, out *kops.Secret, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	if err := Convert_v1alpha2_SecretSpec_To_kops_SecretSpec(&in.Spec, &out.Spec, s); err != nil {
		return err
	}
	return nil
}

// Convert_v1alpha2_Secret_To_kops_Secret is an autogenerated conversion function.
func Convert_v1alpha2_Secret_To_kops_Secret(in *Secret, out *kops.Secret, s conversion.Scope) error {
	return autoConvert_v1alpha2_Secret_To_kops_Secret(in, out, s)
}

func autoConvert_kops_Secret_To_v1alpha2_Secret(in *kops.Secret, out *Secret, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	if err := Convert_kops_SecretSpec_To_v1alpha2_SecretSpec(&in.Spec, &out.Spec, s); err != nil {
		return err
	}
	return nil
}

// Convert_kops_Secret_To_v1alpha2_Secret is an autogenerated conversion function.
func Convert_kops_Secret_To_v1alpha2_Secret(in *kops.Secret, out *Secret, s conversion.Scope) error {
	return autoConvert_kops_Secret_To_v1alpha2_Secret(in, out, s)
}

func autoConvert_v1alpha2_SecretList_To_kops_SecretList(in *SecretList, out *kops.SecretList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]kops.Secret, len(*in))
		for i := range *in {
			if err := Convert_v1alpha2_Secret_To_kops_Secret(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
// Convert_v1alpha2_SecretList_To_kops_SecretList is an autogenerated conversion function.
func Convert_v1alpha2_SecretList_To_kops_SecretList(in *SecretList, out *kops.SecretList, s conversion.Scope) error {
	return autoConvert_v1alpha2_SecretList_To_kops_SecretList(in, out, s)
}

func autoConvert_kops_SecretList_To_v1alpha2_SecretList(in *kops.SecretList, out *SecretList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]Secret, len(*in))
		for i := range *in {
			if err := Convert_kops_Secret_To_v1alpha2_Secret(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
// Convert_kops_SecretList_To_v1alpha2_SecretList is an autogenerated conversion function.
func Convert_kops_SecretList_To_v1alpha2_SecretList(in *kops.SecretList, out *SecretList, s conversion.Scope) error {
	return autoConvert_kops_SecretList_To_v1alpha2_SecretList(in, out, s)
}

func autoConvert_v1alpha2_SecretSpec_To_kops_SecretSpec(in *SecretSpec, out *kops.SecretSpec, s conversion.Scope) error {
	out.SshPublicKey = in.SshPublicKey
	out.Name = in.Name
	return nil
}

// Convert_v1alpha2_SecretSpec_To_kops_SecretSpec is an autogenerated conversion function.
func Convert_v1alpha2_SecretSpec_To_kops_SecretSpec(in *SecretSpec, out *kops.SecretSpec, s conversion.Scope) error {
	return autoConvert_v1alpha2_SecretSpec_To_kops_SecretSpec(in, out, s)
}

func autoConvert_kops_SecretSpec_To_v1alpha2_SecretSpec(in *kops.SecretSpec, out *SecretSpec, s conversion.Scope) error {
	out.SshPublicKey = in.SshPublicKey
	out.Name = in.Name
	return nil
}

// Convert_kops_SecretSpec_To_v1alpha2_SecretSpec is an autogenerated conversion function.
func Convert_kops_SecretSpec_To_v1alpha2_SecretSpec(in *kops.SecretSpec, out *SecretSpec, s conversion.Scope) error {
	return autoConvert_kops_SecretSpec_To_v1alpha2_SecretSpec(in, out, s)
}
