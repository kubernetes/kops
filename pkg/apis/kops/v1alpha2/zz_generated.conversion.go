...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1alpha2_DuplicatStrategy_To_kops_DuplicatStrategy,
		Convert_kops_DuplicatStrategy_To_v1alpha2_DuplicatStrategy,
		...
		Convert_v1alpha2_UpdateStrategy_To_kops_UpdateStrategy,
		Convert_kops_UpdateStrategy_To_v1alpha2_UpdateStrategy,
...
func autoConvert_v1alpha2_DuplicatStrategy_To_kops_DuplicatStrategy(in *DuplicatStrategy, out *kops.DuplicatStrategy, s conversion.Scope) error {
	out.DuplicatInstanceGroup = in.DuplicatInstanceGroup
	return nil
}

// Convert_v1alpha2_DuplicatStrategy_To_kops_DuplicatStrategy is an autogenerated conversion function.
func Convert_v1alpha2_DuplicatStrategy_To_kops_DuplicatStrategy(in *DuplicatStrategy, out *kops.DuplicatStrategy, s conversion.Scope) error {
	return autoConvert_v1alpha2_DuplicatStrategy_To_kops_DuplicatStrategy(in, out, s)
}

func autoConvert_kops_DuplicatStrategy_To_v1alpha2_DuplicatStrategy(in *kops.DuplicatStrategy, out *DuplicatStrategy, s conversion.Scope) error {
	out.DuplicatInstanceGroup = in.DuplicatInstanceGroup
	return nil
}

// Convert_kops_DuplicatStrategy_To_v1alpha2_DuplicatStrategy is an autogenerated conversion function.
func Convert_kops_DuplicatStrategy_To_v1alpha2_DuplicatStrategy(in *kops.DuplicatStrategy, out *DuplicatStrategy, s conversion.Scope) error {
	return autoConvert_kops_DuplicatStrategy_To_v1alpha2_DuplicatStrategy(in, out, s)
}
...
func autoConvert_v1alpha2_InstanceGroupSpec_To_kops_InstanceGroupSpec(in *InstanceGroupSpec, out *kops.InstanceGroupSpec, s conversion.Scope) error {
	if in.Strategy != nil {
		...
		*out = new(kops.UpdateStrategy)
		if err := Convert_v1alpha2_UpdateStrategy_To_kops_UpdateStrategy(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.Strategy = nil
...
func autoConvert_kops_InstanceGroupSpec_To_v1alpha2_InstanceGroupSpec(in *kops.InstanceGroupSpec, out *InstanceGroupSpec, s conversion.Scope) error {
	if in.Strategy != nil {
		...
		*out = new(UpdateStrategy)
		if err := Convert_kops_UpdateStrategy_To_v1alpha2_UpdateStrategy(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.Strategy = nil
...
func autoConvert_v1alpha2_UpdateStrategy_To_kops_UpdateStrategy(in *UpdateStrategy, out *kops.UpdateStrategy, s conversion.Scope) error {
	out.Batch = in.Batch
	out.Drain = in.Drain
...
// Convert_v1alpha2_UpdateStrategy_To_kops_UpdateStrategy is an autogenerated conversion function.
func Convert_v1alpha2_UpdateStrategy_To_kops_UpdateStrategy(in *UpdateStrategy, out *kops.UpdateStrategy, s conversion.Scope) error {
	return autoConvert_v1alpha2_UpdateStrategy_To_kops_UpdateStrategy(in, out, s)
}

func autoConvert_kops_UpdateStrategy_To_v1alpha2_UpdateStrategy(in *kops.UpdateStrategy, out *UpdateStrategy, s conversion.Scope) error {
	out.Batch = in.Batch
	out.Drain = in.Drain
	out.DrainTimeout = in.DrainTimeout
	out.Interval = in.Interval
...
// Convert_kops_UpdateStrategy_To_v1alpha2_UpdateStrategy is an autogenerated conversion function.
func Convert_kops_UpdateStrategy_To_v1alpha2_UpdateStrategy(in *kops.UpdateStrategy, out *UpdateStrategy, s conversion.Scope) error {
	return autoConvert_kops_UpdateStrategy_To_v1alpha2_UpdateStrategy(in, out, s)
}
