...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1alpha2_ExtraUserDataSpec_To_kops_ExtraUserDataSpec,
		Convert_kops_ExtraUserDataSpec_To_v1alpha2_ExtraUserDataSpec,
...
func autoConvert_v1alpha2_ExtraUserDataSpec_To_kops_ExtraUserDataSpec(in *ExtraUserDataSpec, out *kops.ExtraUserDataSpec, s conversion.Scope) error {
	out.Name = in.Name
	out.Type = in.Type
...
// Convert_v1alpha2_ExtraUserDataSpec_To_kops_ExtraUserDataSpec is an autogenerated conversion function.
func Convert_v1alpha2_ExtraUserDataSpec_To_kops_ExtraUserDataSpec(in *ExtraUserDataSpec, out *kops.ExtraUserDataSpec, s conversion.Scope) error {
	return autoConvert_v1alpha2_ExtraUserDataSpec_To_kops_ExtraUserDataSpec(in, out, s)
}

func autoConvert_kops_ExtraUserDataSpec_To_v1alpha2_ExtraUserDataSpec(in *kops.ExtraUserDataSpec, out *ExtraUserDataSpec, s conversion.Scope) error {
	out.Name = in.Name
	out.Type = in.Type
	out.Content = in.Content
	return nil
...
// Convert_kops_ExtraUserDataSpec_To_v1alpha2_ExtraUserDataSpec is an autogenerated conversion function.
func Convert_kops_ExtraUserDataSpec_To_v1alpha2_ExtraUserDataSpec(in *kops.ExtraUserDataSpec, out *ExtraUserDataSpec, s conversion.Scope) error {
	return autoConvert_kops_ExtraUserDataSpec_To_v1alpha2_ExtraUserDataSpec(in, out, s)
}
...
func autoConvert_v1alpha2_InstanceGroupSpec_To_kops_InstanceGroupSpec(in *InstanceGroupSpec, out *kops.InstanceGroupSpec, s conversion.Scope) error {
	...
	if in.ExtraUserData != nil {
		...
		*out = make([]kops.ExtraUserDataSpec, len(*in))
		for i := range *in {
			if err := Convert_v1alpha2_ExtraUserDataSpec_To_kops_ExtraUserDataSpec(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_kops_InstanceGroupSpec_To_v1alpha2_InstanceGroupSpec(in *kops.InstanceGroupSpec, out *InstanceGroupSpec, s conversion.Scope) error {
	...
	if in.ExtraUserData != nil {
		...
		*out = make([]ExtraUserDataSpec, len(*in))
		for i := range *in {
			if err := Convert_kops_ExtraUserDataSpec_To_v1alpha2_ExtraUserDataSpec(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
