...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*NvidiaConfiguration)(nil), (*kops.NvidiaConfiguration)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha2_NvidiaConfiguration_To_kops_NvidiaConfiguration(a.(*NvidiaConfiguration), b.(*kops.NvidiaConfiguration), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*kops.NvidiaConfiguration)(nil), (*NvidiaConfiguration)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_kops_NvidiaConfiguration_To_v1alpha2_NvidiaConfiguration(a.(*kops.NvidiaConfiguration), b.(*NvidiaConfiguration), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha2_ClusterSpec_To_kops_ClusterSpec(in *ClusterSpec, out *kops.ClusterSpec, s conversion.Scope) error {
	...
	if in.Nvidia != nil {
		...
		*out = new(kops.NvidiaConfiguration)
		if err := Convert_v1alpha2_NvidiaConfiguration_To_kops_NvidiaConfiguration(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.Nvidia = nil
...
func autoConvert_kops_ClusterSpec_To_v1alpha2_ClusterSpec(in *kops.ClusterSpec, out *ClusterSpec, s conversion.Scope) error {
	...
	if in.Nvidia != nil {
		...
		*out = new(NvidiaConfiguration)
		if err := Convert_kops_NvidiaConfiguration_To_v1alpha2_NvidiaConfiguration(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.Nvidia = nil
...
func autoConvert_v1alpha2_NvidiaConfiguration_To_kops_NvidiaConfiguration(in *NvidiaConfiguration, out *kops.NvidiaConfiguration, s conversion.Scope) error {
	out.DriverPackage = in.DriverPackage
	out.Install = in.Install
	return nil
}

// Convert_v1alpha2_NvidiaConfiguration_To_kops_NvidiaConfiguration is an autogenerated conversion function.
func Convert_v1alpha2_NvidiaConfiguration_To_kops_NvidiaConfiguration(in *NvidiaConfiguration, out *kops.NvidiaConfiguration, s conversion.Scope) error {
	return autoConvert_v1alpha2_NvidiaConfiguration_To_kops_NvidiaConfiguration(in, out, s)
}

func autoConvert_kops_NvidiaConfiguration_To_v1alpha2_NvidiaConfiguration(in *kops.NvidiaConfiguration, out *NvidiaConfiguration, s conversion.Scope) error {
	out.DriverPackage = in.DriverPackage
	out.Install = in.Install
	return nil
}

// Convert_kops_NvidiaConfiguration_To_v1alpha2_NvidiaConfiguration is an autogenerated conversion function.
func Convert_kops_NvidiaConfiguration_To_v1alpha2_NvidiaConfiguration(in *kops.NvidiaConfiguration, out *NvidiaConfiguration, s conversion.Scope) error {
	return autoConvert_kops_NvidiaConfiguration_To_v1alpha2_NvidiaConfiguration(in, out, s)
}
