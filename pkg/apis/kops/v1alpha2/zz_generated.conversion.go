...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_kops_AmazonVPCIPVlanNetworkingSpec_To_v1alpha2_AmazonVPCIPVlanNetworkingSpec,
...
func autoConvert_v1alpha2_AmazonVPCIPVlanNetworkingSpec_To_kops_AmazonVPCIPVlanNetworkingSpec(in *AmazonVPCIPVlanNetworkingSpec, out *kops.AmazonVPCIPVlanNetworkingSpec, s conversion.Scope) error {
...
// Convert_v1alpha2_AmazonVPCIPVlanNetworkingSpec_To_kops_AmazonVPCIPVlanNetworkingSpec is an autogenerated conversion function.
func Convert_v1alpha2_AmazonVPCIPVlanNetworkingSpec_To_kops_AmazonVPCIPVlanNetworkingSpec(in *AmazonVPCIPVlanNetworkingSpec, out *kops.AmazonVPCIPVlanNetworkingSpec, s conversion.Scope) error {
	return autoConvert_v1alpha2_AmazonVPCIPVlanNetworkingSpec_To_kops_AmazonVPCIPVlanNetworkingSpec(in, out, s)
}

func autoConvert_kops_AmazonVPCIPVlanNetworkingSpec_To_v1alpha2_AmazonVPCIPVlanNetworkingSpec(in *kops.AmazonVPCIPVlanNetworkingSpec, out *AmazonVPCIPVlanNetworkingSpec, s conversion.Scope) error {
	out.SubnetTags = in.SubnetTags
	out.InterfaceIndex = in.InterfaceIndex
	out.RouteToVPCPeers = in.RouteToVPCPeers
	out.SecurityGroupIds = in.SecurityGroupIds
...
// Convert_kops_AmazonVPCIPVlanNetworkingSpec_To_v1alpha2_AmazonVPCIPVlanNetworkingSpec is an autogenerated conversion function.
func Convert_kops_AmazonVPCIPVlanNetworkingSpec_To_v1alpha2_AmazonVPCIPVlanNetworkingSpec(in *kops.AmazonVPCIPVlanNetworkingSpec, out *AmazonVPCIPVlanNetworkingSpec, s conversion.Scope) error {
	return autoConvert_kops_AmazonVPCIPVlanNetworkingSpec_To_v1alpha2_AmazonVPCIPVlanNetworkingSpec(in, out, s)
}
...
func autoConvert_v1alpha2_NetworkingSpec_To_kops_NetworkingSpec(in *NetworkingSpec, out *kops.NetworkingSpec, s conversion.Scope) error {
	...
	if in.AmazonVPCIPVlan != nil {
		...
		*out = new(kops.AmazonVPCIPVlanNetworkingSpec)
		if err := Convert_v1alpha2_AmazonVPCIPVlanNetworkingSpec_To_kops_AmazonVPCIPVlanNetworkingSpec(*in, *out, s); err != nil {
			return err
		}
	} else {
...
func autoConvert_kops_NetworkingSpec_To_v1alpha2_NetworkingSpec(in *kops.NetworkingSpec, out *NetworkingSpec, s conversion.Scope) error {
	...
	if in.AmazonVPCIPVlan != nil {
		...
		*out = new(AmazonVPCIPVlanNetworkingSpec)
		if err := Convert_kops_AmazonVPCIPVlanNetworkingSpec_To_v1alpha2_AmazonVPCIPVlanNetworkingSpec(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.AmazonVPCIPVlan = nil
