...
func Test_BuildMirroredAsset(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			expected: []string{
				"https://artifacts.k8s.io/binaries/kops/1.34.2/linux/amd64/nodeup",
				"https://github.com/kubernetes/kops/releases/download/v1.34.2/nodeup-linux-amd64",
			},
		},
		{
			url: "https://artifacts.k8s.io/binaries/kops/%s/linux/arm64/nodeup",
			expected: []string{
				"https://artifacts.k8s.io/binaries/kops/1.34.2/linux/arm64/nodeup",
				"https://github.com/kubernetes/kops/releases/download/v1.34.2/nodeup-linux-arm64",
			},
		},
	}
