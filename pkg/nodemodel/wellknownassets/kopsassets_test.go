...
func TestBaseURL_OverridesVersionFromKopsBaseURL(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:            "postsubmit URL",
			kopsBaseURL:     "https://storage.googleapis.com/k8s-staging-kops/kops/releases/1.35.0-beta.2+v1.36.2-384-gf369c3ab16",
			expectedVersion: "1.35.0-beta.2+v1.36.2-384-gf369c3ab16",
		},
		{
