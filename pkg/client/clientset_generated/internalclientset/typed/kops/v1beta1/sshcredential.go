...
type SSHCredentialInterface interface {
	Create(ctx context.Context, sSHCredential *v1beta1.SSHCredential, opts v1.CreateOptions) (*v1beta1.SSHCredential, error)
	Update(ctx context.Context, sSHCredential *v1beta1.SSHCredential, opts v1.UpdateOptions) (*v1beta1.SSHCredential, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1beta1.SSHCredential, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1beta1.SSHCredentialList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.SSHCredential, err error)
...
func newSSHCredentials(c *KopsV1beta1Client, namespace string) *sSHCredentials {
...
func (c *sSHCredentials) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.SSHCredential, err error) {
	result = &v1beta1.SSHCredential{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *sSHCredentials) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.SSHCredentialList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.SSHCredentialList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("sshcredentials").
...
func (c *sSHCredentials) Create(ctx context.Context, sSHCredential *v1beta1.SSHCredential, opts v1.CreateOptions) (result *v1beta1.SSHCredential, err error) {
	result = &v1beta1.SSHCredential{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("sshcredentials").
...
func (c *sSHCredentials) Update(ctx context.Context, sSHCredential *v1beta1.SSHCredential, opts v1.UpdateOptions) (result *v1beta1.SSHCredential, err error) {
	result = &v1beta1.SSHCredential{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sshcredentials").
...
func (c *sSHCredentials) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.SSHCredential, err error) {
	result = &v1beta1.SSHCredential{}
