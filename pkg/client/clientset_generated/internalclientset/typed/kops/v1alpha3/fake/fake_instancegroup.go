...
var instancegroupsResource = v1alpha3.SchemeGroupVersion.WithResource("instancegroups")

var instancegroupsKind = v1alpha3.SchemeGroupVersion.WithKind("InstanceGroup")
