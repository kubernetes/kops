...
var sshcredentialsResource = v1alpha3.SchemeGroupVersion.WithResource("sshcredentials")

var sshcredentialsKind = v1alpha3.SchemeGroupVersion.WithKind("SSHCredential")
