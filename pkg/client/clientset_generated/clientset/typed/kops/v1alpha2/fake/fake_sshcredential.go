...
var sshcredentialsResource = v1alpha2.SchemeGroupVersion.WithResource("sshcredentials")

var sshcredentialsKind = v1alpha2.SchemeGroupVersion.WithKind("SSHCredential")
