...
type InstanceGroupInterface interface {
	Create(ctx context.Context, instanceGroup *v1beta1.InstanceGroup, opts v1.CreateOptions) (*v1beta1.InstanceGroup, error)
	Update(ctx context.Context, instanceGroup *v1beta1.InstanceGroup, opts v1.UpdateOptions) (*v1beta1.InstanceGroup, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1beta1.InstanceGroup, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1beta1.InstanceGroupList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.InstanceGroup, err error)
...
func newInstanceGroups(c *KopsV1beta1Client, namespace string) *instanceGroups {
...
func (c *instanceGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.InstanceGroup, err error) {
	result = &v1beta1.InstanceGroup{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *instanceGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.InstanceGroupList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.InstanceGroupList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("instancegroups").
...
func (c *instanceGroups) Create(ctx context.Context, instanceGroup *v1beta1.InstanceGroup, opts v1.CreateOptions) (result *v1beta1.InstanceGroup, err error) {
	result = &v1beta1.InstanceGroup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("instancegroups").
...
func (c *instanceGroups) Update(ctx context.Context, instanceGroup *v1beta1.InstanceGroup, opts v1.UpdateOptions) (result *v1beta1.InstanceGroup, err error) {
	result = &v1beta1.InstanceGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("instancegroups").
...
func (c *instanceGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.InstanceGroup, err error) {
	result = &v1beta1.InstanceGroup{}
