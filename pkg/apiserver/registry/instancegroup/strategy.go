...
func GetAttrs(obj runtime.Object) (labels.Set, fields.Set, error) {
	...
	if !ok {
		return nil, nil, fmt.Errorf("given object is not an InstanceGroup.")
	}
	return labels.Set(instanceGroup.Labels), InstanceGroupToSelectableFields(instanceGroup), nil
}
