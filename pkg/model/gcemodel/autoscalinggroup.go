...
// buildInstanceTemplate returns the GCE instance template object for an InstanceGroup.
...
// splitToZones allocates the instance group's count of nodes amongst the specified zones.
