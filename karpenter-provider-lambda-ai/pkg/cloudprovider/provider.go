...
func resolveRegion(requirements scheduling.Requirements) string {
	requirement := requirements.Get(v1.LabelTopologyZone)
	if requirement == nil || len(requirement.Values()) == 0 {
