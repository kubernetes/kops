locals {
  ...
  ig_bastion_role_arn               = aws_iam_role.ig-bastion-privatecilium-example-com.arn
  ig_bastion_role_name              = aws_iam_role.ig-bastion-privatecilium-example-com.name
  ig_master-us-test-1a_role_arn     = aws_iam_role.ig-master-us-test-1a-privatecilium-example-com.arn
  ig_master-us-test-1a_role_name    = aws_iam_role.ig-master-us-test-1a-privatecilium-example-com.name
  ig_nodes_role_arn                 = aws_iam_role.ig-nodes-privatecilium-example-com.arn
  ig_nodes_role_name                = aws_iam_role.ig-nodes-privatecilium-example-com.name
...
output "ig_bastion_role_arn" {
  value = aws_iam_role.ig-bastion-privatecilium-example-com.arn
}

output "ig_bastion_role_name" {
  value = aws_iam_role.ig-bastion-privatecilium-example-com.name
}

output "ig_master-us-test-1a_role_arn" {
  value = aws_iam_role.ig-master-us-test-1a-privatecilium-example-com.arn
}

output "ig_master-us-test-1a_role_name" {
  value = aws_iam_role.ig-master-us-test-1a-privatecilium-example-com.name
}

output "ig_nodes_role_arn" {
  value = aws_iam_role.ig-nodes-privatecilium-example-com.arn
}

output "ig_nodes_role_name" {
  value = aws_iam_role.ig-nodes-privatecilium-example-com.name
}
...
resource "aws_iam_instance_profile" "ig-bastion-privatecilium-example-com" {
  name = "ig-bastion.privatecilium.example.com"
  role = aws_iam_role.ig-bastion-privatecilium-example-com.name
}

resource "aws_iam_instance_profile" "ig-master-us-test-1a-privatecilium-example-com" {
  name = "ig-master-us-test-1a.privatecilium.example.com"
  role = aws_iam_role.ig-master-us-test-1a-privatecilium-example-com.name
}

resource "aws_iam_instance_profile" "ig-nodes-privatecilium-example-com" {
  name = "ig-nodes.privatecilium.example.com"
  role = aws_iam_role.ig-nodes-privatecilium-example-com.name
}
...
resource "aws_iam_role_policy" "ig-bastion-privatecilium-example-com" {
  name   = "ig-bastion.privatecilium.example.com"
  policy = file("${path.module}/data/aws_iam_role_policy_ig-bastion.privatecilium.example.com_policy")
  role   = aws_iam_role.ig-bastion-privatecilium-example-com.name
}

resource "aws_iam_role_policy" "ig-master-us-test-1a-privatecilium-example-com" {
  name   = "ig-master-us-test-1a.privatecilium.example.com"
  policy = file("${path.module}/data/aws_iam_role_policy_ig-master-us-test-1a.privatecilium.example.com_policy")
  role   = aws_iam_role.ig-master-us-test-1a-privatecilium-example-com.name
}

resource "aws_iam_role_policy" "ig-nodes-privatecilium-example-com" {
  name   = "ig-nodes.privatecilium.example.com"
  policy = file("${path.module}/data/aws_iam_role_policy_ig-nodes.privatecilium.example.com_policy")
  role   = aws_iam_role.ig-nodes-privatecilium-example-com.name
}
...
resource "aws_iam_role" "ig-bastion-privatecilium-example-com" {
  assume_role_policy = file("${path.module}/data/aws_iam_role_ig-bastion.privatecilium.example.com_policy")
  name               = "ig-bastion.privatecilium.example.com"
}

resource "aws_iam_role" "ig-master-us-test-1a-privatecilium-example-com" {
  assume_role_policy = file("${path.module}/data/aws_iam_role_ig-master-us-test-1a.privatecilium.example.com_policy")
  name               = "ig-master-us-test-1a.privatecilium.example.com"
}

resource "aws_iam_role" "ig-nodes-privatecilium-example-com" {
  assume_role_policy = file("${path.module}/data/aws_iam_role_ig-nodes.privatecilium.example.com_policy")
  name               = "ig-nodes.privatecilium.example.com"
}
