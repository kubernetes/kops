...
resource "aws_autoscaling_group" "bastion-private-shared-ip-example-com" {
  ...
  target_group_arns   = [aws_lb_target_group.bastion-private-shared-ip-eepmph.id]
...
resource "aws_autoscaling_group" "master-us-test-1a-masters-private-shared-ip-example-com" {
  ...
  target_group_arns   = [aws_lb_target_group.tcp-private-shared-ip-exa-g7j47a.id]
...
resource "aws_autoscaling_lifecycle_hook" "bastion-NTHLifecycleHook" {
  autoscaling_group_name = aws_autoscaling_group.bastion-private-shared-ip-example-com.id
...
resource "aws_autoscaling_lifecycle_hook" "master-us-test-1a-NTHLifecycleHook" {
  autoscaling_group_name = aws_autoscaling_group.master-us-test-1a-masters-private-shared-ip-example-com.id
  default_result         = "CONTINUE"
  heartbeat_timeout      = 300
  lifecycle_transition   = "autoscaling:EC2_INSTANCE_TERMINATING"
...
resource "aws_autoscaling_lifecycle_hook" "nodes-NTHLifecycleHook" {
  autoscaling_group_name = aws_autoscaling_group.nodes-private-shared-ip-example-com.id
  default_result         = "CONTINUE"
  heartbeat_timeout      = 300
  lifecycle_transition   = "autoscaling:EC2_INSTANCE_TERMINATING"
...
resource "aws_cloudwatch_event_rule" "private-shared-ip-example-com-ASGLifecycle" {
  event_pattern = file("${path.module}/data/aws_cloudwatch_event_rule_private-shared-ip.example.com-ASGLifecycle_event_pattern")
  name          = "private-shared-ip.example.com-ASGLifecycle"
  tags = {
...
resource "aws_cloudwatch_event_rule" "private-shared-ip-example-com-InstanceScheduledChange" {
  event_pattern = file("${path.module}/data/aws_cloudwatch_event_rule_private-shared-ip.example.com-InstanceScheduledChange_event_pattern")
  name          = "private-shared-ip.example.com-InstanceScheduledChange"
  tags = {
    "KubernetesCluster"                                   = "private-shared-ip.example.com"
    "Name"                                                = "private-shared-ip.example.com-InstanceScheduledChange"
    "kubernetes.io/cluster/private-shared-ip.example.com" = "owned"
...
resource "aws_cloudwatch_event_rule" "private-shared-ip-example-com-InstanceStateChange" {
  event_pattern = file("${path.module}/data/aws_cloudwatch_event_rule_private-shared-ip.example.com-InstanceStateChange_event_pattern")
  name          = "private-shared-ip.example.com-InstanceStateChange"
  tags = {
    "KubernetesCluster"                                   = "private-shared-ip.example.com"
    "Name"                                                = "private-shared-ip.example.com-InstanceStateChange"
    "kubernetes.io/cluster/private-shared-ip.example.com" = "owned"
...
resource "aws_cloudwatch_event_rule" "private-shared-ip-example-com-SpotInterruption" {
  event_pattern = file("${path.module}/data/aws_cloudwatch_event_rule_private-shared-ip.example.com-SpotInterruption_event_pattern")
  name          = "private-shared-ip.example.com-SpotInterruption"
  tags = {
    "KubernetesCluster"                                   = "private-shared-ip.example.com"
    "Name"                                                = "private-shared-ip.example.com-SpotInterruption"
    "kubernetes.io/cluster/private-shared-ip.example.com" = "owned"
...
resource "aws_cloudwatch_event_target" "private-shared-ip-example-com-ASGLifecycle-Target" {
  arn  = aws_sqs_queue.private-shared-ip-example-com-nth.arn
  rule = aws_cloudwatch_event_rule.private-shared-ip-example-com-ASGLifecycle.id
}

resource "aws_cloudwatch_event_target" "private-shared-ip-example-com-InstanceScheduledChange-Target" {
  arn  = aws_sqs_queue.private-shared-ip-example-com-nth.arn
  rule = aws_cloudwatch_event_rule.private-shared-ip-example-com-InstanceScheduledChange.id
}

resource "aws_cloudwatch_event_target" "private-shared-ip-example-com-InstanceStateChange-Target" {
  arn  = aws_sqs_queue.private-shared-ip-example-com-nth.arn
  rule = aws_cloudwatch_event_rule.private-shared-ip-example-com-InstanceStateChange.id
}

resource "aws_cloudwatch_event_target" "private-shared-ip-example-com-SpotInterruption-Target" {
  arn  = aws_sqs_queue.private-shared-ip-example-com-nth.arn
  rule = aws_cloudwatch_event_rule.private-shared-ip-example-com-SpotInterruption.id
}
...
resource "aws_lb" "api-private-shared-ip-example-com" {
...
resource "aws_lb" "bastion-private-shared-ip-example-com" {
  enable_cross_zone_load_balancing = false
  internal                         = false
  load_balancer_type               = "network"
...
resource "aws_lb_listener" "api-private-shared-ip-example-com-443" {
  default_action {
    target_group_arn = aws_lb_target_group.tcp-private-shared-ip-exa-g7j47a.id
    type             = "forward"
  }
  load_balancer_arn = aws_lb.api-private-shared-ip-example-com.id
  port              = 443
  protocol          = "TCP"
}

resource "aws_lb_listener" "bastion-private-shared-ip-example-com-22" {
  default_action {
    target_group_arn = aws_lb_target_group.bastion-private-shared-ip-eepmph.id
    type             = "forward"
  }
  load_balancer_arn = aws_lb.bastion-private-shared-ip-example-com.id
  port              = 22
  protocol          = "TCP"
}
...
resource "aws_lb_target_group" "tcp-private-shared-ip-exa-g7j47a" {
  connection_termination = "true"
  deregistration_delay   = "30"
  health_check {
    healthy_threshold   = 2
  ...
  name     = "tcp-private-shared-ip-exa-g7j47a"
  port     = 443
  protocol = "TCP"
  tags = {
    "KubernetesCluster"                                   = "private-shared-ip.example.com"
...
resource "aws_route53_record" "api-private-shared-ip-example-com" {
  alias {
    ...
    name                   = aws_lb.api-private-shared-ip-example-com.dns_name
    zone_id                = aws_lb.api-private-shared-ip-example-com.zone_id
  }
  name    = "api.private-shared-ip.example.com"
  type    = "A"
...
resource "aws_s3_object" "manifests-channels-kops-channels" {
  ...
  key                    = "clusters.example.com/private-shared-ip.example.com/manifests/channels/kops-channels.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}
...
resource "aws_s3_object" "nodeupconfig-master-us-test-1a" {
  ...
  key                    = "clusters.example.com/private-shared-ip.example.com/igconfig/control-plane/master-us-test-1a/nodeupconfig.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}
...
resource "aws_s3_object" "private-shared-ip-example-com-addons-aws-cloud-controller-addons-k8s-io-k8s-1-18" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_object_private-shared-ip.example.com-addons-aws-cloud-controller.addons.k8s.io-k8s-1.18_content")
  key                    = "clusters.example.com/private-shared-ip.example.com/addons/aws-cloud-controller.addons.k8s.io/k8s-1.18.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "aws_s3_object" "private-shared-ip-example-com-addons-aws-ebs-csi-driver-addons-k8s-io-k8s-1-17" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_object_private-shared-ip.example.com-addons-aws-ebs-csi-driver.addons.k8s.io-k8s-1.17_content")
  key                    = "clusters.example.com/private-shared-ip.example.com/addons/aws-ebs-csi-driver.addons.k8s.io/k8s-1.17.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "aws_s3_object" "private-shared-ip-example-com-addons-bootstrap" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_object_private-shared-ip.example.com-addons-bootstrap_content")
  key                    = "clusters.example.com/private-shared-ip.example.com/addons/bootstrap-channel.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "aws_s3_object" "private-shared-ip-example-com-addons-coredns-addons-k8s-io-k8s-1-12" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_object_private-shared-ip.example.com-addons-coredns.addons.k8s.io-k8s-1.12_content")
  key                    = "clusters.example.com/private-shared-ip.example.com/addons/coredns.addons.k8s.io/k8s-1.12.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "aws_s3_object" "private-shared-ip-example-com-addons-dns-controller-addons-k8s-io-k8s-1-12" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_object_private-shared-ip.example.com-addons-dns-controller.addons.k8s.io-k8s-1.12_content")
  key                    = "clusters.example.com/private-shared-ip.example.com/addons/dns-controller.addons.k8s.io/k8s-1.12.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "aws_s3_object" "private-shared-ip-example-com-addons-kops-controller-addons-k8s-io-k8s-1-16" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_object_private-shared-ip.example.com-addons-kops-controller.addons.k8s.io-k8s-1.16_content")
  key                    = "clusters.example.com/private-shared-ip.example.com/addons/kops-controller.addons.k8s.io/k8s-1.16.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "aws_s3_object" "private-shared-ip-example-com-addons-kubelet-api-rbac-addons-k8s-io-k8s-1-9" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_object_private-shared-ip.example.com-addons-kubelet-api.rbac.addons.k8s.io-k8s-1.9_content")
  key                    = "clusters.example.com/private-shared-ip.example.com/addons/kubelet-api.rbac.addons.k8s.io/k8s-1.9.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "aws_s3_object" "private-shared-ip-example-com-addons-limit-range-addons-k8s-io" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_object_private-shared-ip.example.com-addons-limit-range.addons.k8s.io_content")
  key                    = "clusters.example.com/private-shared-ip.example.com/addons/limit-range.addons.k8s.io/v1.5.0.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "aws_s3_object" "private-shared-ip-example-com-addons-node-termination-handler-aws-k8s-1-11" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_object_private-shared-ip.example.com-addons-node-termination-handler.aws-k8s-1.11_content")
  key                    = "clusters.example.com/private-shared-ip.example.com/addons/node-termination-handler.aws/k8s-1.11.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "aws_s3_object" "private-shared-ip-example-com-addons-storage-aws-addons-k8s-io-v1-15-0" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_object_private-shared-ip.example.com-addons-storage-aws.addons.k8s.io-v1.15.0_content")
...
resource "aws_sqs_queue" "private-shared-ip-example-com-nth" {
  message_retention_seconds = 300
  name                      = "private-shared-ip-example-com-nth"
  policy                    = file("${path.module}/data/aws_sqs_queue_private-shared-ip-example-com-nth_policy")
  tags = {
    "KubernetesCluster"                                   = "private-shared-ip.example.com"
    "Name"                                                = "private-shared-ip-example-com-nth"
    "kubernetes.io/cluster/private-shared-ip.example.com" = "owned"
