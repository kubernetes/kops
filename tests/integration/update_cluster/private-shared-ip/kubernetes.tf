...
resource "aws_s3_object" "private-shared-ip-example-com-addons-core-addons-k8s-io" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_object_private-shared-ip.example.com-addons-core.addons.k8s.io_content")
