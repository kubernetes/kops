locals {
  ...
  kube-system-cluster-autoscaler_role_name           = aws_iam_role.cluster-autoscaler-kube-system-sa-minimal-example-com.name
...
output "kube-system-cluster-autoscaler_role_arn" {
  value = aws_iam_role.cluster-autoscaler-kube-system-sa-minimal-example-com.arn
}

output "kube-system-cluster-autoscaler_role_name" {
  value = aws_iam_role.cluster-autoscaler-kube-system-sa-minimal-example-com.name
}
...
resource "aws_iam_role" "cluster-autoscaler-kube-system-sa-minimal-example-com" {
  assume_role_policy = file("${path.module}/data/aws_iam_role_cluster-autoscaler.kube-system.sa.minimal.example.com_policy")
...
resource "aws_iam_role_policy" "cluster-autoscaler-kube-system-sa-minimal-example-com" {
  name   = "cluster-autoscaler.kube-system.sa.minimal.example.com"
  policy = file("${path.module}/data/aws_iam_role_policy_cluster-autoscaler.kube-system.sa.minimal.example.com_policy")
  role   = aws_iam_role.cluster-autoscaler-kube-system-sa-minimal-example-com.name
}
...
resource "aws_security_group_rule" "from-nodes-minimal-example-com-ingress-all-0to0-masters-minimal-example-com" {
  from_port                = 0
  protocol                 = "-1"
  security_group_id        = aws_security_group.masters-minimal-example-com.id
