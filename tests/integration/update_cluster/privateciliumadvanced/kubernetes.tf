...
resource "aws_s3_object" "manifests-etcdmanager-cilium" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_object_manifests-etcdmanager-cilium_content")
...
resource "aws_s3_object" "privateciliumadvanced-example-com-addons-core-addons-k8s-io" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_object_privateciliumadvanced.example.com-addons-core.addons.k8s.io_content")
