...
resource "aws_s3_object" "minimal-gce-ilb-example-com-addons-core-addons-k8s-io" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_object_minimal-gce-ilb.example.com-addons-core.addons.k8s.io_content")
  key                    = "tests/minimal-gce-ilb.example.com/addons/core.addons.k8s.io/v1.4.0.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}
