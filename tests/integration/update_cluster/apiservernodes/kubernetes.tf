locals {
  apiserver_autoscaling_group_ids = [aws_autoscaling_group.apiserver-apiservers-minimal-example-com.id]
  apiserver_security_group_ids    = [aws_security_group.masters-minimal-example-com.id]
  apiservers_role_arn             = aws_iam_role.apiservers-minimal-example-com.arn
  apiservers_role_name            = aws_iam_role.apiservers-minimal-example-com.name
...
output "apiserver_autoscaling_group_ids" {
  value = [aws_autoscaling_group.apiserver-apiservers-minimal-example-com.id]
}

output "apiserver_security_group_ids" {
  value = [aws_security_group.masters-minimal-example-com.id]
}

output "apiservers_role_arn" {
  value = aws_iam_role.apiservers-minimal-example-com.arn
}

output "apiservers_role_name" {
  value = aws_iam_role.apiservers-minimal-example-com.name
}
...
resource "aws_autoscaling_group" "apiserver-apiservers-minimal-example-com" {
...
resource "aws_iam_instance_profile" "apiservers-minimal-example-com" {
  name = "apiservers.minimal.example.com"
  role = aws_iam_role.apiservers-minimal-example-com.name
  tags = {
    "KubernetesCluster"                         = "minimal.example.com"
    "Name"                                      = "apiservers.minimal.example.com"
    "kubernetes.io/cluster/minimal.example.com" = "owned"
...
resource "aws_iam_role" "apiservers-minimal-example-com" {
  assume_role_policy = file("${path.module}/data/aws_iam_role_apiservers.minimal.example.com_policy")
  name               = "apiservers.minimal.example.com"
  tags = {
    "KubernetesCluster"                         = "minimal.example.com"
    "Name"                                      = "apiservers.minimal.example.com"
...
resource "aws_iam_role_policy" "apiservers-minimal-example-com" {
  name   = "apiservers.minimal.example.com"
  policy = file("${path.module}/data/aws_iam_role_policy_apiservers.minimal.example.com_policy")
  role   = aws_iam_role.apiservers-minimal-example-com.name
}
...
resource "aws_launch_template" "apiserver-apiservers-minimal-example-com" {
  ...
  iam_instance_profile {
    name = aws_iam_instance_profile.apiservers-minimal-example-com.id
  }
  ...
  user_data = filebase64("${path.module}/data/aws_launch_template_apiserver.apiservers.minimal.example.com_user_data")
}
...
resource "aws_s3_object" "manifests-channels-kops-channels" {
  ...
  key                    = "clusters.example.com/minimal.example.com/manifests/channels/kops-channels.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}
