...
output "vpc_ipv6_cidr_block" {
  value = aws_vpc.minimal-ipv6-example-com.ipv6_cidr_block
}
...
resource "aws_s3_object" "manifests-channels-kops-channels" {
  ...
  key                    = "clusters.example.com/minimal-ipv6.example.com/manifests/channels/kops-channels.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}
...
resource "aws_subnet" "dualstack-us-test-1a-minimal-ipv6-example-com" {
  ...
  ipv6_cidr_block                                = cidrsubnet(local.vpc_ipv6_cidr_block, 64 - local.vpc_ipv6_cidr_length, 3)
...
resource "aws_subnet" "dualstack-us-test-1b-minimal-ipv6-example-com" {
  ...
  enable_resource_name_dns_a_record_on_launch    = true
  enable_resource_name_dns_aaaa_record_on_launch = true
  ipv6_cidr_block                                = cidrsubnet(local.vpc_ipv6_cidr_block, 64 - local.vpc_ipv6_cidr_length, 4)
  private_dns_hostname_type_on_launch            = "resource-name"
  tags = {
    "KubernetesCluster"                              = "minimal-ipv6.example.com"
...
resource "aws_subnet" "us-test-1a-minimal-ipv6-example-com" {
  ...
  enable_dns64                                   = true
  enable_resource_name_dns_aaaa_record_on_launch = true
  ipv6_cidr_block                                = cidrsubnet(local.vpc_ipv6_cidr_block, 64 - local.vpc_ipv6_cidr_length, 1)
  ipv6_native                                    = true
  private_dns_hostname_type_on_launch            = "resource-name"
  tags = {
    "KubernetesCluster"                              = "minimal-ipv6.example.com"
...
resource "aws_subnet" "us-test-1b-minimal-ipv6-example-com" {
  ...
  enable_dns64                                   = true
  enable_resource_name_dns_aaaa_record_on_launch = true
  ipv6_cidr_block                                = cidrsubnet(local.vpc_ipv6_cidr_block, 64 - local.vpc_ipv6_cidr_length, 2)
  ipv6_native                                    = true
  private_dns_hostname_type_on_launch            = "resource-name"
  tags = {
    "KubernetesCluster"                              = "minimal-ipv6.example.com"
...
resource "aws_subnet" "utility-us-test-1a-minimal-ipv6-example-com" {
  ...
  enable_resource_name_dns_a_record_on_launch    = true
  enable_resource_name_dns_aaaa_record_on_launch = true
  ipv6_cidr_block                                = cidrsubnet(local.vpc_ipv6_cidr_block, 64 - local.vpc_ipv6_cidr_length, 5)
  private_dns_hostname_type_on_launch            = "resource-name"
  tags = {
    "KubernetesCluster"                              = "minimal-ipv6.example.com"
...
resource "aws_subnet" "utility-us-test-1b-minimal-ipv6-example-com" {
  ...
  enable_resource_name_dns_a_record_on_launch    = true
  enable_resource_name_dns_aaaa_record_on_launch = true
  ipv6_cidr_block                                = cidrsubnet(local.vpc_ipv6_cidr_block, 64 - local.vpc_ipv6_cidr_length, 6)
  private_dns_hostname_type_on_launch            = "resource-name"
  tags = {
    "KubernetesCluster"                              = "minimal-ipv6.example.com"
