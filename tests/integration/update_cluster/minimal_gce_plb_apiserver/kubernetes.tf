locals {
  cluster_name = "minimal-gce-plb-apiserver.example.com"
  project      = "testproject"
  region       = "us-test1"
}

output "cluster_name" {
  value = "minimal-gce-plb-apiserver.example.com"
}
...
resource "aws_s3_object" "cluster-completed-spec" {
  ...
  key                    = "tests/minimal-gce-plb-apiserver.example.com/cluster-completed.spec"
  provider               = aws.files
...
resource "aws_s3_object" "etcd-cluster-spec-events" {
  ...
  key                    = "tests/minimal-gce-plb-apiserver.example.com/backups/etcd/events/control/etcd-cluster-spec"
  provider               = aws.files
  server_side_encryption = "AES256"
}
...
resource "aws_s3_object" "etcd-cluster-spec-main" {
  ...
  key                    = "tests/minimal-gce-plb-apiserver.example.com/backups/etcd/main/control/etcd-cluster-spec"
  provider               = aws.files
  server_side_encryption = "AES256"
}
...
resource "aws_s3_object" "kops-version-txt" {
  ...
  key                    = "tests/minimal-gce-plb-apiserver.example.com/kops-version.txt"
  provider               = aws.files
  server_side_encryption = "AES256"
}
...
resource "aws_s3_object" "manifests-channels-kops-channels" {
  ...
  key                    = "tests/minimal-gce-plb-apiserver.example.com/manifests/channels/kops-channels.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}
...
resource "aws_s3_object" "manifests-etcdmanager-events-master-us-test1-a" {
  ...
  key                    = "tests/minimal-gce-plb-apiserver.example.com/manifests/etcd/events-master-us-test1-a.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}
...
resource "aws_s3_object" "manifests-etcdmanager-main-master-us-test1-a" {
  ...
  key                    = "tests/minimal-gce-plb-apiserver.example.com/manifests/etcd/main-master-us-test1-a.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}
...
resource "aws_s3_object" "minimal-gce-plb-apiserver-example-com-addons-bootstrap" {
  ...
  key                    = "tests/minimal-gce-plb-apiserver.example.com/addons/bootstrap-channel.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "aws_s3_object" "minimal-gce-plb-apiserver-example-com-addons-coredns-addons-k8s-io-k8s-1-12" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_object_minimal-gce-plb-apiserver.example.com-addons-coredns.addons.k8s.io-k8s-1.12_content")
  key                    = "tests/minimal-gce-plb-apiserver.example.com/addons/coredns.addons.k8s.io/k8s-1.12.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}
...
resource "aws_s3_object" "minimal-gce-plb-apiserver-example-com-addons-gcp-cloud-controller-addons-k8s-io-k8s-1-23" {
  ...
  key                    = "tests/minimal-gce-plb-apiserver.example.com/addons/gcp-cloud-controller.addons.k8s.io/k8s-1.23.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "aws_s3_object" "minimal-gce-plb-apiserver-example-com-addons-gcp-pd-csi-driver-addons-k8s-io-k8s-1-23" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_object_minimal-gce-plb-apiserver.example.com-addons-gcp-pd-csi-driver.addons.k8s.io-k8s-1.23_content")
  key                    = "tests/minimal-gce-plb-apiserver.example.com/addons/gcp-pd-csi-driver.addons.k8s.io/k8s-1.23.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "aws_s3_object" "minimal-gce-plb-apiserver-example-com-addons-kops-controller-addons-k8s-io-k8s-1-16" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_object_minimal-gce-plb-apiserver.example.com-addons-kops-controller.addons.k8s.io-k8s-1.16_content")
  key                    = "tests/minimal-gce-plb-apiserver.example.com/addons/kops-controller.addons.k8s.io/k8s-1.16.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "aws_s3_object" "minimal-gce-plb-apiserver-example-com-addons-kubelet-api-rbac-addons-k8s-io-k8s-1-9" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_object_minimal-gce-plb-apiserver.example.com-addons-kubelet-api.rbac.addons.k8s.io-k8s-1.9_content")
  key                    = "tests/minimal-gce-plb-apiserver.example.com/addons/kubelet-api.rbac.addons.k8s.io/k8s-1.9.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "aws_s3_object" "minimal-gce-plb-apiserver-example-com-addons-limit-range-addons-k8s-io" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_object_minimal-gce-plb-apiserver.example.com-addons-limit-range.addons.k8s.io_content")
  key                    = "tests/minimal-gce-plb-apiserver.example.com/addons/limit-range.addons.k8s.io/v1.5.0.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "aws_s3_object" "minimal-gce-plb-apiserver-example-com-addons-storage-gce-addons-k8s-io-v1-7-0" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_object_minimal-gce-plb-apiserver.example.com-addons-storage-gce.addons.k8s.io-v1.7.0_content")
  key                    = "tests/minimal-gce-plb-apiserver.example.com/addons/storage-gce.addons.k8s.io/v1.7.0.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}
...
resource "aws_s3_object" "nodeupconfig-apiserver-us-test1-a" {
  ...
  key                    = "tests/minimal-gce-plb-apiserver.example.com/igconfig/apiserver/apiserver-us-test1-a/nodeupconfig.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}
...
resource "aws_s3_object" "nodeupconfig-master-us-test1-a" {
  ...
  key                    = "tests/minimal-gce-plb-apiserver.example.com/igconfig/control-plane/master-us-test1-a/nodeupconfig.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}
...
resource "aws_s3_object" "nodeupconfig-nodes" {
  ...
  key                    = "tests/minimal-gce-plb-apiserver.example.com/igconfig/node/nodes/nodeupconfig.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "google_compute_address" "api-minimal-gce-plb-apiserver-example-com" {
  name = "api-minimal-gce-plb-apiserver-example-com"
}

resource "google_compute_address" "api-us-test1-minimal-gce-plb-apiserver-example-com" {
...
resource "google_compute_disk" "a-etcd-events-minimal-gce-plb-apiserver-example-com" {
  ...
  name = "a-etcd-events-minimal-gce-plb-apiserver-example-com"
  size = 20
  type = "pd-ssd"
  zone = "us-test1-a"
}

resource "google_compute_disk" "a-etcd-main-minimal-gce-plb-apiserver-example-com" {
  labels = {
    "k8s-io-cluster-name" = "minimal-gce-plb-apiserver-example-com"
    "k8s-io-etcd-main"    = "a-2fa"
    "k8s-io-role-master"  = "master"
  }
  name = "a-etcd-main-minimal-gce-plb-apiserver-example-com"
  size = 20
  type = "pd-ssd"
  zone = "us-test1-a"
}

resource "google_compute_firewall" "https-api-ipv6-minimal-gce-plb-apiserver-example-com" {
  allow {
    ports    = ["443"]
    protocol = "tcp"
  }
...
resource "google_compute_firewall" "node-to-master-minimal-gce-plb-apiserver-example-com" {
  allow {
    ports    = ["443"]
    protocol = "tcp"
  }
...
resource "google_compute_firewall" "node-to-node-minimal-gce-plb-apiserver-example-com" {
  ...
  disabled    = false
  name        = "node-to-node-minimal-gce-plb-apiserver-example-com"
  network     = google_compute_network.minimal-gce-plb-apiserver-example-com.name
  source_tags = ["minimal-gce-plb-apiserver-example-com-k8s-io-role-node"]
  target_tags = ["minimal-gce-plb-apiserver-example-com-k8s-io-role-node"]
}

resource "google_compute_firewall" "nodeport-external-to-node-ipv6-minimal-gce-plb-apiserver-eie140" {
  allow {
    ports    = ["30000-32767"]
    protocol = "tcp"
  }
  ...
  disabled      = true
  name          = "nodeport-external-to-node-ipv6-minimal-gce-plb-apiserver-eie140"
  network       = google_compute_network.minimal-gce-plb-apiserver-example-com.name
  source_ranges = ["::/0"]
  target_tags   = ["minimal-gce-plb-apiserver-example-com-k8s-io-role-node"]
}

resource "google_compute_firewall" "nodeport-external-to-node-minimal-gce-plb-apiserver-example-com" {
  allow {
    ports    = ["30000-32767"]
    protocol = "tcp"
  }
  ...
  disabled      = true
  name          = "nodeport-external-to-node-minimal-gce-plb-apiserver-example-com"
  network       = google_compute_network.minimal-gce-plb-apiserver-example-com.name
  source_ranges = ["0.0.0.0/0"]
  target_tags   = ["minimal-gce-plb-apiserver-example-com-k8s-io-role-node"]
}

resource "google_compute_firewall" "ssh-external-to-master-ipv6-minimal-gce-plb-apiserver-ex-eie140" {
  allow {
    ports    = ["22"]
    protocol = "tcp"
  }
...
resource "google_compute_firewall" "ssh-external-to-node-ipv6-minimal-gce-plb-apiserver-example-com" {
  ...
  disabled      = false
  name          = "ssh-external-to-node-ipv6-minimal-gce-plb-apiserver-example-com"
  network       = google_compute_network.minimal-gce-plb-apiserver-example-com.name
  source_ranges = ["::/0"]
  target_tags   = ["minimal-gce-plb-apiserver-example-com-k8s-io-role-node"]
}

resource "google_compute_firewall" "ssh-external-to-node-minimal-gce-plb-apiserver-example-com" {
  allow {
    ports    = ["22"]
    protocol = "tcp"
  }
  disabled      = false
  name          = "ssh-external-to-node-minimal-gce-plb-apiserver-example-com"
  network       = google_compute_network.minimal-gce-plb-apiserver-example-com.name
  source_ranges = ["0.0.0.0/0"]
  target_tags   = ["minimal-gce-plb-apiserver-example-com-k8s-io-role-node"]
}
...
resource "google_compute_forwarding_rule" "api-us-test1-minimal-gce-plb-apiserver-example-com" {
  backend_service = google_compute_region_backend_service.api-minimal-gce-plb-apiserver-example-com.id
  ip_address      = google_compute_address.api-us-test1-minimal-gce-plb-apiserver-example-com.address
  ip_protocol     = "TCP"
  labels = {
    "k8s-io-cluster-name" = "minimal-gce-plb-apiserver-example-com"
    "name"                = "api-us-test1"
...
resource "google_compute_instance_group_manager" "a-apiserver-us-test1-a-minimal-gce-plb-apiserver-example-com" {
  ...
  version {
    instance_template = google_compute_instance_template.apiserver-us-test1-a-minimal-gce-plb-apiserver-example-com.self_link
  }
  zone = "us-test1-a"
}

resource "google_compute_instance_group_manager" "a-master-us-test1-a-minimal-gce-plb-apiserver-example-com" {
  ...
  version {
    instance_template = google_compute_instance_template.master-us-test1-a-minimal-gce-plb-apiserver-example-com.self_link
  }
  zone = "us-test1-a"
}

resource "google_compute_instance_group_manager" "a-nodes-minimal-gce-plb-apiserver-example-com" {
  base_instance_name = "nodes"
  lifecycle {
    ignore_changes = [target_size]
  }
  list_managed_instances_results = "PAGINATED"
  name                           = "a-nodes-minimal-gce-plb-apiserver-example-com"
  target_size                    = 1
  update_policy {
    minimal_action = "REPLACE"
    type           = "OPPORTUNISTIC"
  ...
  version {
    instance_template = google_compute_instance_template.nodes-minimal-gce-plb-apiserver-example-com.self_link
  }
  zone = "us-test1-a"
}

resource "google_compute_instance_group_manager" "b-nodes-minimal-gce-plb-apiserver-example-com" {
  base_instance_name = "nodes"
  lifecycle {
    ignore_changes = [target_size]
  }
  list_managed_instances_results = "PAGINATED"
  name                           = "b-nodes-minimal-gce-plb-apiserver-example-com"
  target_size                    = 1
  update_policy {
    minimal_action = "REPLACE"
    type           = "OPPORTUNISTIC"
...
resource "google_compute_instance_template" "apiserver-us-test1-a-minimal-gce-plb-apiserver-example-com" {
  can_ip_forward = true
  disk {
    auto_delete            = true
    boot                   = true
...
resource "google_compute_instance_template" "master-us-test1-a-minimal-gce-plb-apiserver-example-com" {
  ...
  tags = ["minimal-gce-plb-apiserver-example-com-k8s-io-role-control-plane", "minimal-gce-plb-apiserver-example-com-k8s-io-role-master"]
}

resource "google_compute_instance_template" "nodes-minimal-gce-plb-apiserver-example-com" {
  can_ip_forward = true
  disk {
    auto_delete            = true
    boot                   = true
  ...
  tags = ["minimal-gce-plb-apiserver-example-com-k8s-io-role-node"]
}

resource "google_compute_network" "minimal-gce-plb-apiserver-example-com" {
  auto_create_subnetworks = false
  name                    = "minimal-gce-plb-apiserver-example-com"
}

resource "google_compute_region_backend_service" "api-minimal-gce-plb-apiserver-example-com" {
  backend {
...
resource "google_compute_router" "nat-minimal-gce-plb-apiserver-example-com" {
  name    = "nat-minimal-gce-plb-apiserver-example-com"
  network = google_compute_network.minimal-gce-plb-apiserver-example-com.name
}

resource "google_compute_router_nat" "nat-minimal-gce-plb-apiserver-example-com" {
  name                               = "nat-minimal-gce-plb-apiserver-example-com"
  nat_ip_allocate_option             = "AUTO_ONLY"
  region                             = "us-test1"
  router                             = google_compute_router.nat-minimal-gce-plb-apiserver-example-com.name
  source_subnetwork_ip_ranges_to_nat = "LIST_OF_SUBNETWORKS"
  subnetwork {
    name                    = google_compute_subnetwork.us-test1-minimal-gce-plb-apiserver-example-com.name
    source_ip_ranges_to_nat = ["ALL_IP_RANGES"]
  }
}

resource "google_compute_subnetwork" "us-test1-minimal-gce-plb-apiserver-example-com" {
  ip_cidr_range = "10.0.16.0/20"
  name          = "us-test1-minimal-gce-plb-apiserver-example-com"
  network       = google_compute_network.minimal-gce-plb-apiserver-example-com.name
  region        = "us-test1"
  stack_type    = "IPV4_ONLY"
}
