...
resource "aws_autoscaling_lifecycle_hook" "master-us-test-1a-NTHLifecycleHook" {
  autoscaling_group_name = aws_autoscaling_group.master-us-test-1a-masters-sharedvpc-example-com.id
...
resource "aws_autoscaling_lifecycle_hook" "nodes-NTHLifecycleHook" {
  autoscaling_group_name = aws_autoscaling_group.nodes-sharedvpc-example-com.id
  default_result         = "CONTINUE"
  heartbeat_timeout      = 300
  lifecycle_transition   = "autoscaling:EC2_INSTANCE_TERMINATING"
...
resource "aws_cloudwatch_event_rule" "sharedvpc-example-com-ASGLifecycle" {
  event_pattern = file("${path.module}/data/aws_cloudwatch_event_rule_sharedvpc.example.com-ASGLifecycle_event_pattern")
  name          = "sharedvpc.example.com-ASGLifecycle"
  tags = {
...
resource "aws_cloudwatch_event_rule" "sharedvpc-example-com-InstanceScheduledChange" {
  event_pattern = file("${path.module}/data/aws_cloudwatch_event_rule_sharedvpc.example.com-InstanceScheduledChange_event_pattern")
  name          = "sharedvpc.example.com-InstanceScheduledChange"
  tags = {
    "KubernetesCluster"                           = "sharedvpc.example.com"
    "Name"                                        = "sharedvpc.example.com-InstanceScheduledChange"
    "kubernetes.io/cluster/sharedvpc.example.com" = "owned"
...
resource "aws_cloudwatch_event_rule" "sharedvpc-example-com-InstanceStateChange" {
  event_pattern = file("${path.module}/data/aws_cloudwatch_event_rule_sharedvpc.example.com-InstanceStateChange_event_pattern")
  name          = "sharedvpc.example.com-InstanceStateChange"
  tags = {
    "KubernetesCluster"                           = "sharedvpc.example.com"
    "Name"                                        = "sharedvpc.example.com-InstanceStateChange"
    "kubernetes.io/cluster/sharedvpc.example.com" = "owned"
...
resource "aws_cloudwatch_event_rule" "sharedvpc-example-com-SpotInterruption" {
  event_pattern = file("${path.module}/data/aws_cloudwatch_event_rule_sharedvpc.example.com-SpotInterruption_event_pattern")
  name          = "sharedvpc.example.com-SpotInterruption"
  tags = {
    "KubernetesCluster"                           = "sharedvpc.example.com"
    "Name"                                        = "sharedvpc.example.com-SpotInterruption"
    "kubernetes.io/cluster/sharedvpc.example.com" = "owned"
...
resource "aws_cloudwatch_event_target" "sharedvpc-example-com-ASGLifecycle-Target" {
  arn  = aws_sqs_queue.sharedvpc-example-com-nth.arn
  rule = aws_cloudwatch_event_rule.sharedvpc-example-com-ASGLifecycle.id
}

resource "aws_cloudwatch_event_target" "sharedvpc-example-com-InstanceScheduledChange-Target" {
  arn  = aws_sqs_queue.sharedvpc-example-com-nth.arn
  rule = aws_cloudwatch_event_rule.sharedvpc-example-com-InstanceScheduledChange.id
}

resource "aws_cloudwatch_event_target" "sharedvpc-example-com-InstanceStateChange-Target" {
  arn  = aws_sqs_queue.sharedvpc-example-com-nth.arn
  rule = aws_cloudwatch_event_rule.sharedvpc-example-com-InstanceStateChange.id
}

resource "aws_cloudwatch_event_target" "sharedvpc-example-com-SpotInterruption-Target" {
  arn  = aws_sqs_queue.sharedvpc-example-com-nth.arn
  rule = aws_cloudwatch_event_rule.sharedvpc-example-com-SpotInterruption.id
}
...
resource "aws_s3_object" "manifests-channels-kops-channels" {
  ...
  key                    = "clusters.example.com/sharedvpc.example.com/manifests/channels/kops-channels.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}
...
resource "aws_s3_object" "manifests-etcdmanager-events-master-us-test-1a" {
  ...
  key                    = "clusters.example.com/sharedvpc.example.com/manifests/etcd/events-master-us-test-1a.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}
...
resource "aws_s3_object" "manifests-etcdmanager-main-master-us-test-1a" {
  ...
  key                    = "clusters.example.com/sharedvpc.example.com/manifests/etcd/main-master-us-test-1a.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}
...
resource "aws_s3_object" "nodeupconfig-master-us-test-1a" {
  ...
  key                    = "clusters.example.com/sharedvpc.example.com/igconfig/control-plane/master-us-test-1a/nodeupconfig.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}
...
resource "aws_s3_object" "sharedvpc-example-com-addons-aws-cloud-controller-addons-k8s-io-k8s-1-18" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_object_sharedvpc.example.com-addons-aws-cloud-controller.addons.k8s.io-k8s-1.18_content")
  key                    = "clusters.example.com/sharedvpc.example.com/addons/aws-cloud-controller.addons.k8s.io/k8s-1.18.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "aws_s3_object" "sharedvpc-example-com-addons-aws-ebs-csi-driver-addons-k8s-io-k8s-1-17" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_object_sharedvpc.example.com-addons-aws-ebs-csi-driver.addons.k8s.io-k8s-1.17_content")
  key                    = "clusters.example.com/sharedvpc.example.com/addons/aws-ebs-csi-driver.addons.k8s.io/k8s-1.17.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "aws_s3_object" "sharedvpc-example-com-addons-bootstrap" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_object_sharedvpc.example.com-addons-bootstrap_content")
  key                    = "clusters.example.com/sharedvpc.example.com/addons/bootstrap-channel.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "aws_s3_object" "sharedvpc-example-com-addons-coredns-addons-k8s-io-k8s-1-12" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_object_sharedvpc.example.com-addons-coredns.addons.k8s.io-k8s-1.12_content")
  key                    = "clusters.example.com/sharedvpc.example.com/addons/coredns.addons.k8s.io/k8s-1.12.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "aws_s3_object" "sharedvpc-example-com-addons-dns-controller-addons-k8s-io-k8s-1-12" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_object_sharedvpc.example.com-addons-dns-controller.addons.k8s.io-k8s-1.12_content")
  key                    = "clusters.example.com/sharedvpc.example.com/addons/dns-controller.addons.k8s.io/k8s-1.12.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "aws_s3_object" "sharedvpc-example-com-addons-kops-controller-addons-k8s-io-k8s-1-16" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_object_sharedvpc.example.com-addons-kops-controller.addons.k8s.io-k8s-1.16_content")
  key                    = "clusters.example.com/sharedvpc.example.com/addons/kops-controller.addons.k8s.io/k8s-1.16.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "aws_s3_object" "sharedvpc-example-com-addons-kubelet-api-rbac-addons-k8s-io-k8s-1-9" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_object_sharedvpc.example.com-addons-kubelet-api.rbac.addons.k8s.io-k8s-1.9_content")
  key                    = "clusters.example.com/sharedvpc.example.com/addons/kubelet-api.rbac.addons.k8s.io/k8s-1.9.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "aws_s3_object" "sharedvpc-example-com-addons-limit-range-addons-k8s-io" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_object_sharedvpc.example.com-addons-limit-range.addons.k8s.io_content")
  key                    = "clusters.example.com/sharedvpc.example.com/addons/limit-range.addons.k8s.io/v1.5.0.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "aws_s3_object" "sharedvpc-example-com-addons-node-termination-handler-aws-k8s-1-11" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_object_sharedvpc.example.com-addons-node-termination-handler.aws-k8s-1.11_content")
  key                    = "clusters.example.com/sharedvpc.example.com/addons/node-termination-handler.aws/k8s-1.11.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "aws_s3_object" "sharedvpc-example-com-addons-storage-aws-addons-k8s-io-v1-15-0" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_object_sharedvpc.example.com-addons-storage-aws.addons.k8s.io-v1.15.0_content")
...
resource "aws_sqs_queue" "sharedvpc-example-com-nth" {
  message_retention_seconds = 300
  name                      = "sharedvpc-example-com-nth"
  policy                    = file("${path.module}/data/aws_sqs_queue_sharedvpc-example-com-nth_policy")
  tags = {
    "KubernetesCluster"                           = "sharedvpc.example.com"
    "Name"                                        = "sharedvpc-example-com-nth"
    "kubernetes.io/cluster/sharedvpc.example.com" = "owned"
