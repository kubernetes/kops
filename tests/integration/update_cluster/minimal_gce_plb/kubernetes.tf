locals {
  cluster_name = "minimal-gce-plb.example.com"
  project      = "testproject"
  region       = "us-test1"
}

output "cluster_name" {
  value = "minimal-gce-plb.example.com"
}
...
resource "aws_s3_object" "cluster-completed-spec" {
  ...
  key                    = "tests/minimal-gce-plb.example.com/cluster-completed.spec"
  provider               = aws.files
...
resource "aws_s3_object" "etcd-cluster-spec-events" {
  ...
  key                    = "tests/minimal-gce-plb.example.com/backups/etcd/events/control/etcd-cluster-spec"
  provider               = aws.files
  server_side_encryption = "AES256"
}
...
resource "aws_s3_object" "etcd-cluster-spec-main" {
  ...
  key                    = "tests/minimal-gce-plb.example.com/backups/etcd/main/control/etcd-cluster-spec"
  provider               = aws.files
  server_side_encryption = "AES256"
}
...
resource "aws_s3_object" "kops-version-txt" {
  ...
  key                    = "tests/minimal-gce-plb.example.com/kops-version.txt"
  provider               = aws.files
  server_side_encryption = "AES256"
}
...
resource "aws_s3_object" "manifests-channels-kops-channels" {
  ...
  key                    = "tests/minimal-gce-plb.example.com/manifests/channels/kops-channels.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}
...
resource "aws_s3_object" "manifests-etcdmanager-events-master-us-test1-a" {
  ...
  key                    = "tests/minimal-gce-plb.example.com/manifests/etcd/events-master-us-test1-a.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}
...
resource "aws_s3_object" "manifests-etcdmanager-main-master-us-test1-a" {
  ...
  key                    = "tests/minimal-gce-plb.example.com/manifests/etcd/main-master-us-test1-a.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "aws_s3_object" "minimal-gce-plb-example-com-addons-bootstrap" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_object_minimal-gce-plb.example.com-addons-bootstrap_content")
  key                    = "tests/minimal-gce-plb.example.com/addons/bootstrap-channel.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "aws_s3_object" "minimal-gce-plb-example-com-addons-coredns-addons-k8s-io-k8s-1-12" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_object_minimal-gce-plb.example.com-addons-coredns.addons.k8s.io-k8s-1.12_content")
  key                    = "tests/minimal-gce-plb.example.com/addons/coredns.addons.k8s.io/k8s-1.12.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "aws_s3_object" "minimal-gce-plb-example-com-addons-dns-controller-addons-k8s-io-k8s-1-12" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_object_minimal-gce-plb.example.com-addons-dns-controller.addons.k8s.io-k8s-1.12_content")
  key                    = "tests/minimal-gce-plb.example.com/addons/dns-controller.addons.k8s.io/k8s-1.12.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "aws_s3_object" "minimal-gce-plb-example-com-addons-gcp-cloud-controller-addons-k8s-io-k8s-1-23" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_object_minimal-gce-plb.example.com-addons-gcp-cloud-controller.addons.k8s.io-k8s-1.23_content")
  key                    = "tests/minimal-gce-plb.example.com/addons/gcp-cloud-controller.addons.k8s.io/k8s-1.23.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "aws_s3_object" "minimal-gce-plb-example-com-addons-gcp-pd-csi-driver-addons-k8s-io-k8s-1-23" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_object_minimal-gce-plb.example.com-addons-gcp-pd-csi-driver.addons.k8s.io-k8s-1.23_content")
  key                    = "tests/minimal-gce-plb.example.com/addons/gcp-pd-csi-driver.addons.k8s.io/k8s-1.23.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "aws_s3_object" "minimal-gce-plb-example-com-addons-kops-controller-addons-k8s-io-k8s-1-16" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_object_minimal-gce-plb.example.com-addons-kops-controller.addons.k8s.io-k8s-1.16_content")
  key                    = "tests/minimal-gce-plb.example.com/addons/kops-controller.addons.k8s.io/k8s-1.16.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "aws_s3_object" "minimal-gce-plb-example-com-addons-kubelet-api-rbac-addons-k8s-io-k8s-1-9" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_object_minimal-gce-plb.example.com-addons-kubelet-api.rbac.addons.k8s.io-k8s-1.9_content")
  key                    = "tests/minimal-gce-plb.example.com/addons/kubelet-api.rbac.addons.k8s.io/k8s-1.9.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "aws_s3_object" "minimal-gce-plb-example-com-addons-limit-range-addons-k8s-io" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_object_minimal-gce-plb.example.com-addons-limit-range.addons.k8s.io_content")
  key                    = "tests/minimal-gce-plb.example.com/addons/limit-range.addons.k8s.io/v1.5.0.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "aws_s3_object" "minimal-gce-plb-example-com-addons-storage-gce-addons-k8s-io-v1-7-0" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_object_minimal-gce-plb.example.com-addons-storage-gce.addons.k8s.io-v1.7.0_content")
  key                    = "tests/minimal-gce-plb.example.com/addons/storage-gce.addons.k8s.io/v1.7.0.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}
...
resource "aws_s3_object" "nodeupconfig-master-us-test1-a" {
  ...
  key                    = "tests/minimal-gce-plb.example.com/igconfig/control-plane/master-us-test1-a/nodeupconfig.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}
...
resource "aws_s3_object" "nodeupconfig-nodes" {
  ...
  key                    = "tests/minimal-gce-plb.example.com/igconfig/node/nodes/nodeupconfig.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}
...
resource "google_compute_disk" "a-etcd-main-minimal-gce-plb-example-com" {
  labels = {
    "k8s-io-cluster-name" = "minimal-gce-plb-example-com"
...
resource "google_compute_firewall" "master-to-node-minimal-gce-plb-example-com" {
  ...
  disabled    = false
  name        = "master-to-node-minimal-gce-plb-example-com"
  network     = google_compute_network.minimal-gce-plb-example-com.name
...
resource "google_compute_firewall" "node-to-master-minimal-gce-plb-example-com" {
  allow {
    ports    = ["443"]
    protocol = "tcp"
  }
  ...
  network     = google_compute_network.minimal-gce-plb-example-com.name
  source_tags = ["minimal-gce-plb-example-com-k8s-io-role-node"]
  target_tags = ["minimal-gce-plb-example-com-k8s-io-role-control-plane", "minimal-gce-plb-example-com-k8s-io-role-master"]
}

resource "google_compute_firewall" "node-to-node-minimal-gce-plb-example-com" {
  allow {
    protocol = "tcp"
  }
  allow {
  ...
  disabled    = false
  name        = "node-to-node-minimal-gce-plb-example-com"
  network     = google_compute_network.minimal-gce-plb-example-com.name
  source_tags = ["minimal-gce-plb-example-com-k8s-io-role-node"]
  target_tags = ["minimal-gce-plb-example-com-k8s-io-role-node"]
}

resource "google_compute_firewall" "nodeport-external-to-node-ipv6-minimal-gce-plb-example-com" {
  allow {
    ports    = ["30000-32767"]
    protocol = "tcp"
  }
  ...
  disabled      = true
  name          = "nodeport-external-to-node-ipv6-minimal-gce-plb-example-com"
  network       = google_compute_network.minimal-gce-plb-example-com.name
  source_ranges = ["::/0"]
  target_tags   = ["minimal-gce-plb-example-com-k8s-io-role-node"]
}

resource "google_compute_firewall" "nodeport-external-to-node-minimal-gce-plb-example-com" {
  allow {
    ports    = ["30000-32767"]
    protocol = "tcp"
  }
  ...
  disabled      = true
  name          = "nodeport-external-to-node-minimal-gce-plb-example-com"
  network       = google_compute_network.minimal-gce-plb-example-com.name
  source_ranges = ["0.0.0.0/0"]
  target_tags   = ["minimal-gce-plb-example-com-k8s-io-role-node"]
}

resource "google_compute_firewall" "ssh-external-to-master-ipv6-minimal-gce-plb-example-com" {
  allow {
    ports    = ["22"]
    protocol = "tcp"
  }
...
resource "google_compute_firewall" "ssh-external-to-node-ipv6-minimal-gce-plb-example-com" {
  ...
  disabled      = false
  name          = "ssh-external-to-node-ipv6-minimal-gce-plb-example-com"
  network       = google_compute_network.minimal-gce-plb-example-com.name
  source_ranges = ["::/0"]
  target_tags   = ["minimal-gce-plb-example-com-k8s-io-role-node"]
}

resource "google_compute_firewall" "ssh-external-to-node-minimal-gce-plb-example-com" {
  allow {
    ports    = ["22"]
    protocol = "tcp"
  }
  disabled      = false
  name          = "ssh-external-to-node-minimal-gce-plb-example-com"
  network       = google_compute_network.minimal-gce-plb-example-com.name
  source_ranges = ["0.0.0.0/0"]
  target_tags   = ["minimal-gce-plb-example-com-k8s-io-role-node"]
}
...
resource "google_compute_forwarding_rule" "api-minimal-gce-plb-example-com" {
  backend_service = google_compute_region_backend_service.api-public-minimal-gce-plb-example-com.id
...
resource "google_compute_instance_group_manager" "b-nodes-minimal-gce-plb-example-com" {
  base_instance_name = "nodes"
  lifecycle {
    ignore_changes = [target_size]
  }
...
resource "google_compute_region_backend_service" "api-minimal-gce-plb-example-com" {
  ...
  health_checks         = [google_compute_region_health_check.api-https-minimal-gce-plb-example-com.id]
  load_balancing_scheme = "INTERNAL"
  name                  = "api-minimal-gce-plb-example-com"
  protocol              = "TCP"
}

resource "google_compute_region_backend_service" "api-public-minimal-gce-plb-example-com" {
  backend {
    balancing_mode = "CONNECTION"
    group          = google_compute_instance_group_manager.a-master-us-test1-a-minimal-gce-plb-example-com.instance_group
  }
  health_checks         = [google_compute_region_health_check.api-https-minimal-gce-plb-example-com.id]
  load_balancing_scheme = "EXTERNAL"
  name                  = "api-public-minimal-gce-plb-example-com"
  protocol              = "TCP"
}

resource "google_compute_region_health_check" "api-https-minimal-gce-plb-example-com" {
  https_health_check {
    port         = 443
    request_path = "/readyz"
  }
  name = "api-https-minimal-gce-plb-example-com"
}
...
resource "google_compute_router_nat" "nat-minimal-gce-plb-example-com" {
  name                               = "nat-minimal-gce-plb-example-com"
  nat_ip_allocate_option             = "AUTO_ONLY"
  region                             = "us-test1"
  router                             = google_compute_router.nat-minimal-gce-plb-example-com.name
  source_subnetwork_ip_ranges_to_nat = "LIST_OF_SUBNETWORKS"
  subnetwork {
    name                    = google_compute_subnetwork.us-test1-minimal-gce-plb-example-com.name
    source_ip_ranges_to_nat = ["ALL_IP_RANGES"]
  }
}

resource "google_compute_subnetwork" "us-test1-minimal-gce-plb-example-com" {
