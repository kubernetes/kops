...
resource "aws_s3_object" "gossip-k8s-local-addons-hcloud-cloud-controller-addons-k8s-io-k8s-1-22" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_object_gossip.k8s.local-addons-hcloud-cloud-controller.addons.k8s.io-k8s-1.22_content")
  key                    = "tests/gossip.k8s.local/addons/hcloud-cloud-controller.addons.k8s.io/k8s-1.22.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}
...
resource "aws_s3_object" "gossip-k8s-local-addons-hcloud-csi-driver-addons-k8s-io-k8s-1-22" {
  ...
  key                    = "tests/gossip.k8s.local/addons/hcloud-csi-driver.addons.k8s.io/k8s-1.22.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}
...
resource "aws_s3_object" "manifests-etcdmanager-events-master-fsn1" {
  ...
  key                    = "tests/gossip.k8s.local/manifests/etcd/events-master-fsn1.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}
...
resource "aws_s3_object" "manifests-etcdmanager-main-master-fsn1" {
  ...
  key                    = "tests/gossip.k8s.local/manifests/etcd/main-master-fsn1.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}
...
resource "aws_s3_object" "nodeupconfig-master-fsn1" {
  ...
  key                    = "tests/gossip.k8s.local/igconfig/control-plane/master-fsn1/nodeupconfig.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}
...
resource "aws_s3_object" "nodeupconfig-nodes-fsn1" {
  ...
  key                    = "tests/gossip.k8s.local/igconfig/node/nodes-fsn1/nodeupconfig.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "hcloud_firewall" "control-plane-gossip-k8s-local" {
  apply_to {
    label_selector = "kops.k8s.io/cluster=gossip.k8s.local,kops.k8s.io/instance-role=ControlPlane"
  }
  labels = {
...
resource "hcloud_firewall" "nodes-gossip-k8s-local" {
  apply_to {
    label_selector = "kops.k8s.io/cluster=gossip.k8s.local,kops.k8s.io/instance-role=Node"
  }
  labels = {
    "kops.k8s.io/cluster"       = "gossip.k8s.local"
...
resource "hcloud_load_balancer" "api-gossip-k8s-local" {
  labels = {
    "kops.k8s.io/cluster" = "gossip.k8s.local"
  }
...
resource "hcloud_load_balancer_network" "api-gossip-k8s-local" {
  load_balancer_id = hcloud_load_balancer.api-gossip-k8s-local.id
  network_id       = hcloud_network.gossip-k8s-local.id
}

resource "hcloud_load_balancer_service" "api-gossip-k8s-local-tcp-3988" {
...
resource "hcloud_load_balancer_service" "api-gossip-k8s-local-tcp-443" {
...
resource "hcloud_load_balancer_target" "api-gossip-k8s-local" {
  label_selector   = "kops.k8s.io/cluster=gossip.k8s.local,kops.k8s.io/instance-role=ControlPlane"
  load_balancer_id = hcloud_load_balancer.api-gossip-k8s-local.id
  type             = "label_selector"
  use_private_ip   = true
...
resource "hcloud_network" "gossip-k8s-local" {
...
resource "hcloud_network_subnet" "gossip-k8s-local-10-0-0-0--16" {
  ip_range     = "10.0.0.0/16"
  network_id   = hcloud_network.gossip-k8s-local.id
...
resource "hcloud_server" "master-fsn1" {
  ...
  server_type = "cx23"
  ssh_keys    = [hcloud_ssh_key.gossip-k8s-local-c4_a6_ed_9a_a8_89_b9_e2_c3_9c_d6_63_eb_9c_71_57.id]
...
resource "hcloud_ssh_key" "gossip-k8s-local-c4_a6_ed_9a_a8_89_b9_e2_c3_9c_d6_63_eb_9c_71_57" {
  labels = {
    "kops.k8s.io/cluster" = "gossip.k8s.local"
  }
  name       = "gossip.k8s.local-c4:a6:ed:9a:a8:89:b9:e2:c3:9c:d6:63:eb:9c:71:57"
...
resource "hcloud_volume" "etcd-1-etcd-events-gossip-k8s-local" {
  labels = {
    "kops.k8s.io/cluster"        = "gossip.k8s.local"
    "kops.k8s.io/instance-group" = "master-fsn1"
...
resource "hcloud_volume" "etcd-1-etcd-main-gossip-k8s-local" {
  labels = {
    "kops.k8s.io/cluster"        = "gossip.k8s.local"
    "kops.k8s.io/instance-group" = "master-fsn1"
