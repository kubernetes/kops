...
resource "aws_s3_object" "existing-iam-example-com-addons-core-addons-k8s-io" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_object_existing-iam.example.com-addons-core.addons.k8s.io_content")
