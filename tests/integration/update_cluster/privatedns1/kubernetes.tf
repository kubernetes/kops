...
resource "aws_autoscaling_group" "bastion-privatedns1-example-com" {
  ...
  target_group_arns   = [aws_lb_target_group.bastion-privatedns1-examp-mbgbef.id]
...
resource "aws_autoscaling_group" "master-us-test-1a-masters-privatedns1-example-com" {
  ...
  target_group_arns   = [aws_lb_target_group.tcp-privatedns1-example-c-1ia51c.id]
...
resource "aws_launch_template" "bastion-privatedns1-example-com" {
  ...
  iam_instance_profile {
    name = aws_iam_instance_profile.bastions-privatedns1-example-com.id
  }
...
resource "aws_launch_template" "master-us-test-1a-masters-privatedns1-example-com" {
  ...
  iam_instance_profile {
    name = aws_iam_instance_profile.masters-privatedns1-example-com.id
  }
  image_id      = "ami-12345678"
...
resource "aws_launch_template" "nodes-privatedns1-example-com" {
  ...
  iam_instance_profile {
    name = aws_iam_instance_profile.nodes-privatedns1-example-com.id
  }
  image_id      = "ami-12345678"
...
resource "aws_lb" "api-privatedns1-example-com" {
...
resource "aws_lb" "bastion-privatedns1-example-com" {
  enable_cross_zone_load_balancing = false
  internal                         = false
  load_balancer_type               = "network"
...
resource "aws_lb_listener" "api-privatedns1-example-com-443" {
  default_action {
    target_group_arn = aws_lb_target_group.tcp-privatedns1-example-c-1ia51c.id
    type             = "forward"
  }
  load_balancer_arn = aws_lb.api-privatedns1-example-com.id
  port              = 443
  protocol          = "TCP"
}

resource "aws_lb_listener" "bastion-privatedns1-example-com-22" {
  default_action {
    target_group_arn = aws_lb_target_group.bastion-privatedns1-examp-mbgbef.id
    type             = "forward"
  }
  load_balancer_arn = aws_lb.bastion-privatedns1-example-com.id
  port              = 22
  protocol          = "TCP"
}
...
resource "aws_lb_target_group" "tcp-privatedns1-example-c-1ia51c" {
  connection_termination = "true"
  deregistration_delay   = "30"
  health_check {
    healthy_threshold   = 2
  ...
  name     = "tcp-privatedns1-example-c-1ia51c"
  port     = 443
  protocol = "TCP"
  tags = {
    "KubernetesCluster"                             = "privatedns1.example.com"
...
resource "aws_route53_record" "api-privatedns1-example-com" {
  alias {
    ...
    name                   = aws_lb.api-privatedns1-example-com.dns_name
    zone_id                = aws_lb.api-privatedns1-example-com.zone_id
  }
  name    = "api.privatedns1.example.com"
  type    = "A"
...
resource "aws_s3_object" "manifests-channels-kops-channels" {
  ...
  key                    = "clusters.example.com/privatedns1.example.com/manifests/channels/kops-channels.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}
...
resource "aws_s3_object" "manifests-etcdmanager-events-master-us-test-1a" {
  ...
  key                    = "clusters.example.com/privatedns1.example.com/manifests/etcd/events-master-us-test-1a.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}
...
resource "aws_s3_object" "manifests-etcdmanager-main-master-us-test-1a" {
  ...
  key                    = "clusters.example.com/privatedns1.example.com/manifests/etcd/main-master-us-test-1a.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}
...
resource "aws_s3_object" "privatedns1-example-com-addons-aws-ebs-csi-driver-addons-k8s-io-k8s-1-17" {
  ...
  key                    = "clusters.example.com/privatedns1.example.com/addons/aws-ebs-csi-driver.addons.k8s.io/k8s-1.17.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "aws_s3_object" "privatedns1-example-com-addons-bootstrap" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_object_privatedns1.example.com-addons-bootstrap_content")
  key                    = "clusters.example.com/privatedns1.example.com/addons/bootstrap-channel.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "aws_s3_object" "privatedns1-example-com-addons-coredns-addons-k8s-io-k8s-1-12" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_object_privatedns1.example.com-addons-coredns.addons.k8s.io-k8s-1.12_content")
  key                    = "clusters.example.com/privatedns1.example.com/addons/coredns.addons.k8s.io/k8s-1.12.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "aws_s3_object" "privatedns1-example-com-addons-dns-controller-addons-k8s-io-k8s-1-12" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_object_privatedns1.example.com-addons-dns-controller.addons.k8s.io-k8s-1.12_content")
  key                    = "clusters.example.com/privatedns1.example.com/addons/dns-controller.addons.k8s.io/k8s-1.12.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "aws_s3_object" "privatedns1-example-com-addons-kops-controller-addons-k8s-io-k8s-1-16" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_object_privatedns1.example.com-addons-kops-controller.addons.k8s.io-k8s-1.16_content")
  key                    = "clusters.example.com/privatedns1.example.com/addons/kops-controller.addons.k8s.io/k8s-1.16.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "aws_s3_object" "privatedns1-example-com-addons-kubelet-api-rbac-addons-k8s-io-k8s-1-9" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_object_privatedns1.example.com-addons-kubelet-api.rbac.addons.k8s.io-k8s-1.9_content")
  key                    = "clusters.example.com/privatedns1.example.com/addons/kubelet-api.rbac.addons.k8s.io/k8s-1.9.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "aws_s3_object" "privatedns1-example-com-addons-limit-range-addons-k8s-io" {
  bucket                 = "testingBucket"
...
resource "aws_security_group_rule" "from-api-elb-privatedns1-example-com-egress-all-0to0-__--0" {
  from_port         = 0
  ipv6_cidr_blocks  = ["::/0"]
  protocol          = "-1"
  security_group_id = aws_security_group.api-elb-privatedns1-example-com.id
...
resource "aws_security_group_rule" "from-bastion-privatedns1-example-com-egress-all-0to0-__--0" {
  from_port         = 0
  ipv6_cidr_blocks  = ["::/0"]
  protocol          = "-1"
  security_group_id = aws_security_group.bastion-privatedns1-example-com.id
...
resource "aws_security_group_rule" "from-masters-privatedns1-example-com-egress-all-0to0-__--0" {
  from_port         = 0
  ipv6_cidr_blocks  = ["::/0"]
  protocol          = "-1"
  security_group_id = aws_security_group.masters-privatedns1-example-com.id
...
resource "aws_security_group_rule" "from-nodes-privatedns1-example-com-egress-all-0to0-__--0" {
  from_port         = 0
  ipv6_cidr_blocks  = ["::/0"]
  protocol          = "-1"
  security_group_id = aws_security_group.nodes-privatedns1-example-com.id
