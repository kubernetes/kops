locals {
  ...
  bastion_role_arn                  = aws_iam_role.bastions-privatedns1-example-com.arn
  bastion_role_name                 = aws_iam_role.bastions-privatedns1-example-com.name
  bastion_security_group_ids        = [aws_security_group.bastion-privatedns1-example-com.id]
  cluster_name                      = "privatedns1.example.com"
  master-us-test-1a_role_arn        = aws_iam_role.masters-privatedns1-example-com.arn
  master-us-test-1a_role_name       = aws_iam_role.masters-privatedns1-example-com.name
