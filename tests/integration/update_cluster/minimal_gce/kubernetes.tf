...
resource "aws_s3_object" "minimal-gce-example-com-addons-core-addons-k8s-io" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_object_minimal-gce.example.com-addons-core.addons.k8s.io_content")
