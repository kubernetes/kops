locals {
  ...
  vpc_ipv6_cidr_block          = aws_vpc.nthsqsresources-longclustername-example-com.ipv6_cidr_block
...
output "vpc_ipv6_cidr_block" {
  value = aws_vpc.nthsqsresources-longclustername-example-com.ipv6_cidr_block
}
...
resource "aws_s3_object" "manifests-etcdmanager-events-master-us-test-1a" {
  ...
  key                    = "clusters.example.com/nthsqsresources.longclustername.example.com/manifests/etcd/events-master-us-test-1a.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}
...
resource "aws_s3_object" "manifests-etcdmanager-main-master-us-test-1a" {
  ...
  key                    = "clusters.example.com/nthsqsresources.longclustername.example.com/manifests/etcd/main-master-us-test-1a.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}
