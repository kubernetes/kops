...
resource "aws_key_pair" "kubernetes-minimal-warmpool-example-com-c4a6ed9aa889b9e2c39cd663eb9c7157" {
...
resource "aws_launch_template" "master-us-test-1a-masters-minimal-warmpool-example-com" {
  ...
  key_name      = aws_key_pair.kubernetes-minimal-warmpool-example-com-c4a6ed9aa889b9e2c39cd663eb9c7157.id
  lifecycle {
...
resource "aws_s3_object" "manifests-channels-kops-channels" {
  ...
  key                    = "clusters.example.com/minimal-warmpool.example.com/manifests/channels/kops-channels.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}
...
resource "aws_s3_object" "minimal-warmpool-example-com-addons-aws-cloud-controller-addons-k8s-io-k8s-1-18" {
  bucket                 = "testingBucket"
...
resource "aws_s3_object" "minimal-warmpool-example-com-addons-aws-ebs-csi-driver-addons-k8s-io-k8s-1-17" {
  bucket                 = "testingBucket"
...
resource "aws_s3_object" "minimal-warmpool-example-com-addons-coredns-addons-k8s-io-k8s-1-12" {
  bucket                 = "testingBucket"
...
resource "aws_s3_object" "minimal-warmpool-example-com-addons-dns-controller-addons-k8s-io-k8s-1-12" {
  bucket                 = "testingBucket"
...
resource "aws_s3_object" "minimal-warmpool-example-com-addons-kops-controller-addons-k8s-io-k8s-1-16" {
  bucket                 = "testingBucket"
...
resource "aws_s3_object" "minimal-warmpool-example-com-addons-kubelet-api-rbac-addons-k8s-io-k8s-1-9" {
  bucket                 = "testingBucket"
...
resource "aws_s3_object" "minimal-warmpool-example-com-addons-storage-aws-addons-k8s-io-v1-15-0" {
  bucket                 = "testingBucket"
...
resource "aws_security_group_rule" "from-0-0-0-0--0-ingress-tcp-22to22-masters-minimal-warmpool-example-com" {
...
resource "aws_security_group_rule" "from-0-0-0-0--0-ingress-tcp-22to22-nodes-minimal-warmpool-example-com" {
  cidr_blocks       = ["0.0.0.0/0"]
  from_port         = 22
  protocol          = "tcp"
...
resource "aws_security_group_rule" "from-0-0-0-0--0-ingress-tcp-443to443-masters-minimal-warmpool-example-com" {
  cidr_blocks       = ["0.0.0.0/0"]
  from_port         = 443
  protocol          = "tcp"
  security_group_id = aws_security_group.masters-minimal-warmpool-example-com.id
...
resource "aws_security_group_rule" "from-masters-minimal-warmpool-example-com-egress-all-0to0-0-0-0-0--0" {
  cidr_blocks       = ["0.0.0.0/0"]
  from_port         = 0
  protocol          = "-1"
  security_group_id = aws_security_group.masters-minimal-warmpool-example-com.id
...
resource "aws_security_group_rule" "from-masters-minimal-warmpool-example-com-ingress-all-0to0-masters-minimal-warmpool-example-com" {
  from_port                = 0
  protocol                 = "-1"
  security_group_id        = aws_security_group.masters-minimal-warmpool-example-com.id
...
resource "aws_security_group_rule" "from-masters-minimal-warmpool-example-com-ingress-all-0to0-nodes-minimal-warmpool-example-com" {
  from_port                = 0
  protocol                 = "-1"
  security_group_id        = aws_security_group.nodes-minimal-warmpool-example-com.id
  source_security_group_id = aws_security_group.masters-minimal-warmpool-example-com.id
...
resource "aws_security_group_rule" "from-nodes-minimal-warmpool-example-com-egress-all-0to0-0-0-0-0--0" {
  cidr_blocks       = ["0.0.0.0/0"]
  from_port         = 0
  protocol          = "-1"
  security_group_id = aws_security_group.nodes-minimal-warmpool-example-com.id
...
resource "aws_security_group_rule" "from-nodes-minimal-warmpool-example-com-ingress-all-0to0-nodes-minimal-warmpool-example-com" {
  from_port                = 0
  protocol                 = "-1"
  security_group_id        = aws_security_group.nodes-minimal-warmpool-example-com.id
...
resource "aws_security_group_rule" "from-nodes-minimal-warmpool-example-com-ingress-tcp-2382to4000-masters-minimal-warmpool-example-com" {
  from_port                = 2382
  protocol                 = "tcp"
  security_group_id        = aws_security_group.masters-minimal-warmpool-example-com.id
  source_security_group_id = aws_security_group.nodes-minimal-warmpool-example-com.id
...
resource "aws_security_group_rule" "from-nodes-minimal-warmpool-example-com-ingress-tcp-4003to65535-masters-minimal-warmpool-example-com" {
  from_port                = 4003
  protocol                 = "tcp"
  security_group_id        = aws_security_group.masters-minimal-warmpool-example-com.id
  source_security_group_id = aws_security_group.nodes-minimal-warmpool-example-com.id
...
resource "aws_security_group_rule" "from-nodes-minimal-warmpool-example-com-ingress-udp-1to65535-masters-minimal-warmpool-example-com" {
  from_port                = 1
  protocol                 = "udp"
  security_group_id        = aws_security_group.masters-minimal-warmpool-example-com.id
  source_security_group_id = aws_security_group.nodes-minimal-warmpool-example-com.id
