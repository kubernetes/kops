...
resource "aws_s3_bucket_object" "bottlerocket-example-com-addons-authentication-aws-k8s-1-12" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_bucket_object_bottlerocket.example.com-addons-authentication.aws-k8s-1.12_content")
  key                    = "clusters.example.com/bottlerocket.example.com/addons/authentication.aws/k8s-1.12.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "aws_s3_bucket_object" "bottlerocket-example-com-addons-aws-ebs-csi-driver-addons-k8s-io-k8s-1-17" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_bucket_object_bottlerocket.example.com-addons-aws-ebs-csi-driver.addons.k8s.io-k8s-1.17_content")
  key                    = "clusters.example.com/bottlerocket.example.com/addons/aws-ebs-csi-driver.addons.k8s.io/k8s-1.17.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "aws_s3_bucket_object" "bottlerocket-example-com-addons-bootstrap" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_bucket_object_bottlerocket.example.com-addons-bootstrap_content")
  key                    = "clusters.example.com/bottlerocket.example.com/addons/bootstrap-channel.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "aws_s3_bucket_object" "bottlerocket-example-com-addons-core-addons-k8s-io" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_bucket_object_bottlerocket.example.com-addons-core.addons.k8s.io_content")
  key                    = "clusters.example.com/bottlerocket.example.com/addons/core.addons.k8s.io/v1.4.0.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "aws_s3_bucket_object" "bottlerocket-example-com-addons-coredns-addons-k8s-io-k8s-1-12" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_bucket_object_bottlerocket.example.com-addons-coredns.addons.k8s.io-k8s-1.12_content")
  key                    = "clusters.example.com/bottlerocket.example.com/addons/coredns.addons.k8s.io/k8s-1.12.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "aws_s3_bucket_object" "bottlerocket-example-com-addons-csr-approver-addons-k8s-io-k8s-1-23" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_bucket_object_bottlerocket.example.com-addons-csr-approver.addons.k8s.io-k8s-1.23_content")
  key                    = "clusters.example.com/bottlerocket.example.com/addons/csr-approver.addons.k8s.io/k8s-1.23.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "aws_s3_bucket_object" "bottlerocket-example-com-addons-dns-controller-addons-k8s-io-k8s-1-12" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_bucket_object_bottlerocket.example.com-addons-dns-controller.addons.k8s.io-k8s-1.12_content")
  key                    = "clusters.example.com/bottlerocket.example.com/addons/dns-controller.addons.k8s.io/k8s-1.12.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "aws_s3_bucket_object" "bottlerocket-example-com-addons-kops-controller-addons-k8s-io-k8s-1-16" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_bucket_object_bottlerocket.example.com-addons-kops-controller.addons.k8s.io-k8s-1.16_content")
  key                    = "clusters.example.com/bottlerocket.example.com/addons/kops-controller.addons.k8s.io/k8s-1.16.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "aws_s3_bucket_object" "bottlerocket-example-com-addons-kubelet-api-rbac-addons-k8s-io-k8s-1-9" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_bucket_object_bottlerocket.example.com-addons-kubelet-api.rbac.addons.k8s.io-k8s-1.9_content")
  key                    = "clusters.example.com/bottlerocket.example.com/addons/kubelet-api.rbac.addons.k8s.io/k8s-1.9.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "aws_s3_bucket_object" "bottlerocket-example-com-addons-limit-range-addons-k8s-io" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_bucket_object_bottlerocket.example.com-addons-limit-range.addons.k8s.io_content")
  key                    = "clusters.example.com/bottlerocket.example.com/addons/limit-range.addons.k8s.io/v1.5.0.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "aws_s3_bucket_object" "bottlerocket-example-com-addons-networking-cilium-io-k8s-1-16" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_bucket_object_bottlerocket.example.com-addons-networking.cilium.io-k8s-1.16_content")
  key                    = "clusters.example.com/bottlerocket.example.com/addons/networking.cilium.io/k8s-1.16-v1.10.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}

resource "aws_s3_bucket_object" "bottlerocket-example-com-addons-storage-aws-addons-k8s-io-v1-15-0" {
  bucket                 = "testingBucket"
  content                = file("${path.module}/data/aws_s3_bucket_object_bottlerocket.example.com-addons-storage-aws.addons.k8s.io-v1.15.0_content")
  key                    = "clusters.example.com/bottlerocket.example.com/addons/storage-aws.addons.k8s.io/v1.15.0.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}
...
resource "aws_s3_bucket_object" "cluster-completed-spec" {
  ...
  key                    = "clusters.example.com/bottlerocket.example.com/cluster-completed.spec"
  provider               = aws.files
  server_side_encryption = "AES256"
}
...
resource "aws_s3_bucket_object" "etcd-cluster-spec-events" {
  ...
  key                    = "clusters.example.com/bottlerocket.example.com/backups/etcd/events/control/etcd-cluster-spec"
  provider               = aws.files
  server_side_encryption = "AES256"
}
...
resource "aws_s3_bucket_object" "etcd-cluster-spec-main" {
  ...
  key                    = "clusters.example.com/bottlerocket.example.com/backups/etcd/main/control/etcd-cluster-spec"
  provider               = aws.files
  server_side_encryption = "AES256"
}
...
resource "aws_s3_bucket_object" "kops-version-txt" {
  ...
  key                    = "clusters.example.com/bottlerocket.example.com/kops-version.txt"
  provider               = aws.files
  server_side_encryption = "AES256"
}
...
resource "aws_s3_bucket_object" "manifests-etcdmanager-events" {
  ...
  key                    = "clusters.example.com/bottlerocket.example.com/manifests/etcd/events.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}
...
resource "aws_s3_bucket_object" "manifests-etcdmanager-main" {
  ...
  key                    = "clusters.example.com/bottlerocket.example.com/manifests/etcd/main.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}
...
resource "aws_s3_bucket_object" "manifests-static-kube-apiserver-healthcheck" {
  ...
  key                    = "clusters.example.com/bottlerocket.example.com/manifests/static/kube-apiserver-healthcheck.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}
...
resource "aws_s3_bucket_object" "nodeupconfig-master-us-test-1a" {
  ...
  key                    = "clusters.example.com/bottlerocket.example.com/igconfig/master/master-us-test-1a/nodeupconfig.yaml"
  provider               = aws.files
  server_side_encryption = "AES256"
}
...
resource "aws_security_group_rule" "from-0-0-0-0--0-ingress-tcp-22to22-masters-bottlerocket-example-com" {
...
resource "aws_security_group_rule" "from-0-0-0-0--0-ingress-tcp-22to22-nodes-bottlerocket-example-com" {
  cidr_blocks       = ["0.0.0.0/0"]
  from_port         = 22
  protocol          = "tcp"
...
resource "aws_security_group_rule" "from-0-0-0-0--0-ingress-tcp-443to443-masters-bottlerocket-example-com" {
  cidr_blocks       = ["0.0.0.0/0"]
  from_port         = 443
  protocol          = "tcp"
  security_group_id = aws_security_group.masters-bottlerocket-example-com.id
...
resource "aws_security_group_rule" "from-masters-bottlerocket-example-com-egress-all-0to0-0-0-0-0--0" {
  cidr_blocks       = ["0.0.0.0/0"]
  from_port         = 0
  protocol          = "-1"
  security_group_id = aws_security_group.masters-bottlerocket-example-com.id
...
resource "aws_security_group_rule" "from-masters-bottlerocket-example-com-egress-all-0to0-__--0" {
  from_port         = 0
  ipv6_cidr_blocks  = ["::/0"]
  protocol          = "-1"
  security_group_id = aws_security_group.masters-bottlerocket-example-com.id
...
resource "aws_security_group_rule" "from-masters-bottlerocket-example-com-ingress-all-0to0-masters-bottlerocket-example-com" {
  from_port                = 0
  protocol                 = "-1"
  security_group_id        = aws_security_group.masters-bottlerocket-example-com.id
...
resource "aws_security_group_rule" "from-masters-bottlerocket-example-com-ingress-all-0to0-nodes-bottlerocket-example-com" {
  from_port                = 0
  protocol                 = "-1"
  security_group_id        = aws_security_group.nodes-bottlerocket-example-com.id
  source_security_group_id = aws_security_group.masters-bottlerocket-example-com.id
...
resource "aws_security_group_rule" "from-nodes-bottlerocket-example-com-egress-all-0to0-0-0-0-0--0" {
  cidr_blocks       = ["0.0.0.0/0"]
  from_port         = 0
  protocol          = "-1"
  security_group_id = aws_security_group.nodes-bottlerocket-example-com.id
...
resource "aws_security_group_rule" "from-nodes-bottlerocket-example-com-egress-all-0to0-__--0" {
  from_port         = 0
  ipv6_cidr_blocks  = ["::/0"]
  protocol          = "-1"
  security_group_id = aws_security_group.nodes-bottlerocket-example-com.id
...
resource "aws_security_group_rule" "from-nodes-bottlerocket-example-com-ingress-all-0to0-nodes-bottlerocket-example-com" {
  from_port                = 0
  protocol                 = "-1"
  security_group_id        = aws_security_group.nodes-bottlerocket-example-com.id
...
resource "aws_security_group_rule" "from-nodes-bottlerocket-example-com-ingress-tcp-1to2379-masters-bottlerocket-example-com" {
  from_port                = 1
  protocol                 = "tcp"
  security_group_id        = aws_security_group.masters-bottlerocket-example-com.id
  source_security_group_id = aws_security_group.nodes-bottlerocket-example-com.id
...
resource "aws_security_group_rule" "from-nodes-bottlerocket-example-com-ingress-tcp-2382to4000-masters-bottlerocket-example-com" {
  from_port                = 2382
  protocol                 = "tcp"
  security_group_id        = aws_security_group.masters-bottlerocket-example-com.id
  source_security_group_id = aws_security_group.nodes-bottlerocket-example-com.id
...
resource "aws_security_group_rule" "from-nodes-bottlerocket-example-com-ingress-tcp-4003to65535-masters-bottlerocket-example-com" {
  from_port                = 4003
  protocol                 = "tcp"
  security_group_id        = aws_security_group.masters-bottlerocket-example-com.id
  source_security_group_id = aws_security_group.nodes-bottlerocket-example-com.id
...
resource "aws_security_group_rule" "from-nodes-bottlerocket-example-com-ingress-udp-1to65535-masters-bottlerocket-example-com" {
  from_port                = 1
  protocol                 = "udp"
  security_group_id        = aws_security_group.masters-bottlerocket-example-com.id
  source_security_group_id = aws_security_group.nodes-bottlerocket-example-com.id
