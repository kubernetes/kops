...
KOPS_SCHEDULER_QPS="${KOPS_SCHEDULER_QPS:-300}"
KOPS_SCHEDULER_BURST="${KOPS_SCHEDULER_BURST:-300}"
KOPS_CONTROLLER_MANAGER_QPS="${KOPS_CONTROLLER_MANAGER_QPS:-300}"
KOPS_CONTROLLER_MANAGER_BURST="${KOPS_CONTROLLER_MANAGER_BURST:-300}"
