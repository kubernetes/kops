...
# Shared orchestration for upgrade-ab style scenarios. Source after lib/common.sh.
#
# kops-upgrade runs an A->B kops upgrade test. The caller passes the full
# create-args string (e.g. "--networking calico" or
# "--networking cilium --api-loadbalancer-type=public --api-loadbalancer-class=network").
#
# Required env vars: KOPS_VERSION_A, KOPS_VERSION_B, K8S_VERSION_A, K8S_VERSION_B.
# Optional env vars: KOPS_TEMPLATE, KOPS_CONTROL_PLANE_COUNT, KOPS_SKIP_E2E.
