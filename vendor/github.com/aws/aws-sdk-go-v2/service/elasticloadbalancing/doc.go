...
//
// Elastic Load Balancing A load balancer can distribute incoming traffic across
...
// connections from the load balancer to the instances. Elastic Load Balancing
