...
// update, the firewall rule with the specified name will be replaced with
// this new firewall rule.
//
...
// account to which to add the firewall rule. firewallRuleName is the name of
// the firewall rule to create or update. parameters is parameters supplied
