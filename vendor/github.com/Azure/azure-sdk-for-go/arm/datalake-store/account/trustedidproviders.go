...
// During update, the trusted identity provider with the specified name will
...
// account to which to add the trusted identity provider.
// trustedIDProviderName is the name of the trusted identity provider. This
// is used for differentiation of providers in the account. parameters is
