...
// CommitmentPlanListResultPreparer prepares a request to retrieve the next set of results. It returns
// nil if no more results exist.
...
// CommitmentPlanPatchPayload is the properties of a commitment plan which may
