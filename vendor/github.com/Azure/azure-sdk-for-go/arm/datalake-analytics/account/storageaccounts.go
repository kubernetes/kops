...
// Optional. selectParameter is oData Select statement. Limits the properties
// on each entry to just those requested, e.g.
...
// Update updates the Data Lake Analytics account to replace Azure Storage
...
// the access key and suffix to update the storage account with, if any.
