...
// $expand=resourceTypes/aliases.
func (client ProvidersClient) List(ctx context.Context, expand string) (result ProviderListResultPage, err error) {
	if tracing.IsEnabled() {
...
func (client ProvidersClient) ListPreparer(ctx context.Context, expand string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"subscriptionId": autorest.Encode("path", client.SubscriptionID),
	}
...
func (client ProvidersClient) ListComplete(ctx context.Context, expand string) (result ProviderListResultIterator, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/ProvidersClient.List")
		defer func() {
			sc := -1
...
// retrieve resource provider metadata. To include property aliases in response, use
// $expand=resourceTypes/aliases.
func (client ProvidersClient) ListAtTenantScope(ctx context.Context, expand string) (result ProviderListResultPage, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.ListAtTenantScopePreparer(ctx, expand)
	if err != nil {
...
func (client ProvidersClient) ListAtTenantScopePreparer(ctx context.Context, expand string) (*http.Request, error) {
	const APIVersion = "2021-04-01"
	queryParameters := map[string]interface{}{
		"api-version": APIVersion,
	}
...
func (client ProvidersClient) ListAtTenantScopeComplete(ctx context.Context, expand string) (result ProviderListResultIterator, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/ProvidersClient.ListAtTenantScope")
		defer func() {
			sc := -1
	...
	result.page, err = client.ListAtTenantScope(ctx, expand)
	return
}
...
// Parameters:
// resourceProviderNamespace - the namespace of the resource provider.
func (client ProvidersClient) ProviderPermissions(ctx context.Context, resourceProviderNamespace string) (result ProviderPermissionListResult, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/ProvidersClient.ProviderPermissions")
		defer func() {
			sc := -1
			if result.Response.Response != nil {
				sc = result.Response.Response.StatusCode
	...
	req, err := client.ProviderPermissionsPreparer(ctx, resourceProviderNamespace)
	if err != nil {
		err = autorest.NewErrorWithError(err, "resources.ProvidersClient", "ProviderPermissions", nil, "Failure preparing request")
		return
	}

	resp, err := client.ProviderPermissionsSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "resources.ProvidersClient", "ProviderPermissions", resp, "Failure sending request")
		return
	}

	result, err = client.ProviderPermissionsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "resources.ProvidersClient", "ProviderPermissions", resp, "Failure responding to request")
		return
	}
...
// ProviderPermissionsPreparer prepares the ProviderPermissions request.
func (client ProvidersClient) ProviderPermissionsPreparer(ctx context.Context, resourceProviderNamespace string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"resourceProviderNamespace": autorest.Encode("path", resourceProviderNamespace),
		"subscriptionId":            autorest.Encode("path", client.SubscriptionID),
	}
	...
	preparer := autorest.CreatePreparer(
		autorest.AsGet(),
		autorest.WithBaseURL(client.BaseURI),
		autorest.WithPathParameters("/subscriptions/{subscriptionId}/providers/{resourceProviderNamespace}/providerPermissions", pathParameters),
		autorest.WithQueryParameters(queryParameters))
	return preparer.Prepare((&http.Request{}).WithContext(ctx))
}

// ProviderPermissionsSender sends the ProviderPermissions request. The method will close the
// http.Response Body if it receives an error.
func (client ProvidersClient) ProviderPermissionsSender(req *http.Request) (*http.Response, error) {
	return client.Send(req, azure.DoRetryWithRegistration(client.Client))
}

// ProviderPermissionsResponder handles the response to the ProviderPermissions request. The method always
// closes the http.Response Body.
func (client ProvidersClient) ProviderPermissionsResponder(resp *http.Response) (result ProviderPermissionListResult, err error) {
	err = autorest.Respond(
		resp,
		azure.WithErrorUnlessStatusCode(http.StatusOK),
		autorest.ByUnmarshallingJSON(&result),
...
func (client ProvidersClient) Register(ctx context.Context, resourceProviderNamespace string, properties *ProviderRegistrationRequest) (result Provider, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.RegisterPreparer(ctx, resourceProviderNamespace, properties)
	if err != nil {
...
func (client ProvidersClient) RegisterPreparer(ctx context.Context, resourceProviderNamespace string, properties *ProviderRegistrationRequest) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"resourceProviderNamespace": autorest.Encode("path", resourceProviderNamespace),
		"subscriptionId":            autorest.Encode("path", client.SubscriptionID),
	}
...
// a resource provider with resource types that can be deployed at the management group scope. It does not recursively
// register subscriptions within the management group. Instead, you must register subscriptions individually.
// Parameters:
// resourceProviderNamespace - the namespace of the resource provider to register.
