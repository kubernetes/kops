...
func (m *PostgresqlHostConfig14_1C) SetWorkMem(v *wrapperspb.Int64Value) {
	m.WorkMem = v
}
...
func (m *PostgresqlHostConfig14_1C) SetConstraintExclusion(v PostgresqlHostConfig14_1C_ConstraintExclusion) {
...
func (m *PostgresqlHostConfig14_1C) SetForceParallelMode(v PostgresqlHostConfig14_1C_ForceParallelMode) {
	m.ForceParallelMode = v
}

func (m *PostgresqlHostConfig14_1C) SetClientMinMessages(v PostgresqlHostConfig14_1C_LogLevel) {
	m.ClientMinMessages = v
}

func (m *PostgresqlHostConfig14_1C) SetLogMinMessages(v PostgresqlHostConfig14_1C_LogLevel) {
	m.LogMinMessages = v
}
...
func (m *PostgresqlHostConfig14_1C) SetLogErrorVerbosity(v PostgresqlHostConfig14_1C_LogErrorVerbosity) {
...
func (m *PostgresqlHostConfig14_1C) SetLogStatement(v PostgresqlHostConfig14_1C_LogStatement) {
	m.LogStatement = v
}
...
func (m *PostgresqlHostConfig14_1C) SetDefaultTransactionIsolation(v PostgresqlHostConfig14_1C_TransactionIsolation) {
...
func (m *PostgresqlHostConfig14_1C) SetByteaOutput(v PostgresqlHostConfig14_1C_ByteaOutput) {
	m.ByteaOutput = v
}

func (m *PostgresqlHostConfig14_1C) SetXmlbinary(v PostgresqlHostConfig14_1C_XmlBinary) {
	m.Xmlbinary = v
}

func (m *PostgresqlHostConfig14_1C) SetXmloption(v PostgresqlHostConfig14_1C_XmlOption) {
	m.Xmloption = v
}
...
func (m *PostgresqlHostConfig14_1C) SetBackslashQuote(v PostgresqlHostConfig14_1C_BackslashQuote) {
	m.BackslashQuote = v
}
