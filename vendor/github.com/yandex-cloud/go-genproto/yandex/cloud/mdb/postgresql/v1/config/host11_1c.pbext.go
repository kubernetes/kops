...
func (m *PostgresqlHostConfig11_1C) SetWorkMem(v *wrapperspb.Int64Value) {
	m.WorkMem = v
}
...
func (m *PostgresqlHostConfig11_1C) SetConstraintExclusion(v PostgresqlHostConfig11_1C_ConstraintExclusion) {
...
func (m *PostgresqlHostConfig11_1C) SetForceParallelMode(v PostgresqlHostConfig11_1C_ForceParallelMode) {
	m.ForceParallelMode = v
}

func (m *PostgresqlHostConfig11_1C) SetClientMinMessages(v PostgresqlHostConfig11_1C_LogLevel) {
	m.ClientMinMessages = v
}

func (m *PostgresqlHostConfig11_1C) SetLogMinMessages(v PostgresqlHostConfig11_1C_LogLevel) {
	m.LogMinMessages = v
}
...
func (m *PostgresqlHostConfig11_1C) SetLogErrorVerbosity(v PostgresqlHostConfig11_1C_LogErrorVerbosity) {
...
func (m *PostgresqlHostConfig11_1C) SetLogStatement(v PostgresqlHostConfig11_1C_LogStatement) {
	m.LogStatement = v
}
...
func (m *PostgresqlHostConfig11_1C) SetDefaultTransactionIsolation(v PostgresqlHostConfig11_1C_TransactionIsolation) {
...
func (m *PostgresqlHostConfig11_1C) SetByteaOutput(v PostgresqlHostConfig11_1C_ByteaOutput) {
	m.ByteaOutput = v
}

func (m *PostgresqlHostConfig11_1C) SetXmlbinary(v PostgresqlHostConfig11_1C_XmlBinary) {
	m.Xmlbinary = v
}

func (m *PostgresqlHostConfig11_1C) SetXmloption(v PostgresqlHostConfig11_1C_XmlOption) {
	m.Xmloption = v
}
...
func (m *PostgresqlHostConfig11_1C) SetBackslashQuote(v PostgresqlHostConfig11_1C_BackslashQuote) {
	m.BackslashQuote = v
}
