...
func (c *BackupServiceClient) BackupIterator(ctx context.Context, req *redis.ListBackupsRequest, opts ...grpc.CallOption) *BackupIterator {
	var pageSize int64
...
func (it *BackupIterator) Take(size int64) ([]*redis.Backup, error) {
	if it.err != nil {
		return nil, it.err
	}
...
func (it *BackupIterator) TakeAll() ([]*redis.Backup, error) {
	return it.Take(0)
}
