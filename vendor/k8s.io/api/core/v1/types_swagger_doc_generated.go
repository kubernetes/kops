...
var map_NodeSpec = map[string]string{
	...
	"externalID":    "Deprecated. Not all kubelet will set this field. Remove field after 1.13. see: https://issues.k8s.io/61966",
}
...
var map_PersistentVolumeSource = map[string]string{
	...
	"cinder":               "Cinder represents a cinder volume attached and mounted on kubelet host machine. More info: https://examples.k8s.io/mysql-cinder-pd/README.md",
	...
	"vsphereVolume":        "VsphereVolume represents a vSphere volume attached and mounted on kubelet host machine",
	"quobyte":              "Quobyte represents a Quobyte mount on the host that shares a pod's lifetime",
	"azureDisk":            "AzureDisk represents an Azure Data Disk mount on the host and bind mount to the pod.",
	"photonPersistentDisk": "PhotonPersistentDisk represents a PhotonController persistent disk attached and mounted on kubelet host machine",
	"portworxVolume":       "PortworxVolume represents a portworx volume attached and mounted on kubelet host machine",
