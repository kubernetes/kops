...
* Automated Kubernetes cluster [CRUD](/docs/commands.md) for the ([AWS](/docs/aws.md))
...
* Easy command line syntax with autocomplete
* Community support

## Installing

`kubectl` is required. Install [instructions](http://kubernetes.io/docs/user-guide/prereqs/).
...
## Other Resources
 ...
 - Learn about [InstanceGroups](docs/instance_groups.md), which let you change
 instance types, cluster sizes, and other options
