...
// TestMinimalGCE runs tests on a minimal GCP configuration
...
// TestMinimalGCEPrivate runs tests on a minimal GCP configuration with private topology.
...
// TestMinimalGCEInternalLoadBalancer runs tests on a minimal GCP configuration with an internal load balancer.
...
// TestMinimalGCELongClusterName runs tests on a minimal GCP configuration with a very long cluster name
...
// TestMinimalGCEInternalLoadBalancerLongClusterName runs tests on a minimal GCP configuration with an internal load balancer and a very long cluster name
...
// TestHighAvailabilityGCE runs the test on a simple HA GCP configuration, similar to kops create cluster ha-gce.example.com
