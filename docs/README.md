...
* [`etcd` backup/restore and volume encryption setup](operations/etcd_backup_restore_encryption.md)
* [GPU setup](gpu.md)
...
* [`k8s` upgrading](operations/updates_and_upgrades.md)
* [`kops` updating](operations/updates_and_upgrades.md)
